...
public class a {
    ...
    static class b extends a {
        ...
        public boolean a(byte[] r12, int r13, int r14, boolean r15) {
            throw new UnsupportedOperationException("Method not decompiled: me.kiip.internal.h.a.b.a(byte[], int, int, boolean):boolean");
...
*/
    ...
    public static String a_(byte[] bArr, int i) {
        try {
    ...
    public static byte[] a_(byte[] bArr, int i, int i2, int i3) {
        ...
        if (bVar.e && i2 > 0) {
            i4 += (bVar.f ? GoogleScorer.CLIENT_PLUS : 1) * (((i2 - 1) / 57) + 1);
        }
        bVar.a = new byte[i4];
