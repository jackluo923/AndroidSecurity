...
public class JsonHttpResponseHandler extends AsyncHttpResponseHandler {
    ...
    protected void handleFailureMessage(java.lang.Throwable r3, java.lang.String r4) {
        throw new UnsupportedOperationException("Method not decompiled: com.loopj.twicecircled.android.http.JsonHttpResponseHandler.handleFailureMessage(java.lang.Throwable, java.lang.String):void");
        /*
        r2 = this;
    ...
    protected void handleSuccessJsonMessage(int i, Object obj) {
        if (obj instanceof JSONObject) {
            ...
            onFailure(new JSONException(new StringBuilder("Unexpected type ").append(obj.getClass().getName()).toString()), null);
        }
    }
