    ...
    private void makeRequestWithRetries() {
        ...
        while (z) {
            try {
                ...
                th = new IOException("NPE in HttpClient" + e5.getMessage());
        ...
        try {
            ...
            if (this.responseHandler != null) {
                ...
                if (this.isBinaryRequest) {
                    this.responseHandler.sendFailureMessage(th2, (byte[]) i);
                } else {
                    this.responseHandler.sendFailureMessage(th2, (String) i);
                }
            }
        }
    }
