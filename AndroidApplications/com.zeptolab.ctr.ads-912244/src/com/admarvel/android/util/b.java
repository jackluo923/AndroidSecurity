...
public class b {
    ...
    static class c extends a {
        ...
        public c(int i, byte[] bArr) {
            ...
            this.j = new byte[2];
            this.c = 0;
            this.k = this.e ? ApiEventType.API_MRAID_GET_DEFAULT_POSITION : -1;
        }

        public boolean a(byte[] r12, int r13, int r14, boolean r15) {
            throw new UnsupportedOperationException("Method not decompiled: com.admarvel.android.util.b.c.a(byte[], int, int, boolean):boolean");
...
*/
    ...
    public static byte[] a(byte[] bArr, int i, int i2, int i3) {
        ...
        if (!bVar.a(bArr, i, i2, true)) {
            ...
            System.arraycopy(bVar.a, 0, obj, 0, bVar.b);
            return obj;
        }
    }

    public static String b_(byte[] bArr, int i) {
        try {
    ...
    public static byte[] b_(byte[] bArr, int i, int i2, int i3) {
        ...
        if (cVar.e && i2 > 0) {
            i4 += (cVar.f ? GoogleScorer.CLIENT_PLUS : 1) * (((i2 - 1) / 57) + 1);
        }
        cVar.a = new byte[i4];
