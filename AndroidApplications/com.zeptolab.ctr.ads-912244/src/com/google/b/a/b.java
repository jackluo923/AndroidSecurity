        ...
        while (i2 < length) {
            ...
            if (c2 != c || b >= (byte) -5) {
                ...
                if (b >= (byte) -1 && c2 == '=') {
                    if (i == 0) {
                        if (i2 < 2) {
                            throw new a(new StringBuilder("Invalid padding char found in position ").append(i2).toString());
                        }
                        z = 1;
                    ...
                    throw new a(new StringBuilder("Data found after trailing padding char at index ").append(i2).toString());
                } else {
                    i4 = i3 + 1;
                    cArr[i3] = c2;
                    if (i4 == 4) {
                ...
                throw new a(new StringBuilder("Bad Base64 input character at ").append(i2).append(": ").append(toCharArray[i2 + 0]).append("(decimal)").toString());
            }
        }
        if (i3 == 0 || i3 != 1) {
            cArr[i3] = '=';
            ...
            throw new a(new StringBuilder("single trailing character at offset ").append(length - 1).toString());
        }
