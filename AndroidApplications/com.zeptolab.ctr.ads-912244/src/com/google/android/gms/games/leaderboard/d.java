...
public final class d implements LeaderboardScore {
    ...
    static int a(LeaderboardScore leaderboardScore) {
        return ep.hashCode(new Object[]{Long.valueOf(leaderboardScore.getRank()), leaderboardScore.getDisplayRank(), Long.valueOf(leaderboardScore.getRawScore()), leaderboardScore.getDisplayScore(), Long.valueOf(leaderboardScore.getTimestampMillis()), leaderboardScore.getScoreHolderDisplayName(), leaderboardScore.getScoreHolderIconImageUri(), leaderboardScore.getScoreHolderHiResImageUri(), leaderboardScore.getScoreHolder()});
    }

    static boolean a(LeaderboardScore leaderboardScore, LeaderboardScore leaderboardScore2) {
        if (!(leaderboardScore2 instanceof LeaderboardScore)) {
            return false;
        }
        if (leaderboardScore == leaderboardScore2) {
            return true;
        }
        leaderboardScore2 = leaderboardScore2;
    ...
    public void getScoreHolderDisplayName(CharArrayBuffer charArrayBuffer) {
        if (this.IY == null) {
            fm.b(this.IV, charArrayBuffer);
        } else {
            this.IY.getDisplayName(charArrayBuffer);
        }
    }
