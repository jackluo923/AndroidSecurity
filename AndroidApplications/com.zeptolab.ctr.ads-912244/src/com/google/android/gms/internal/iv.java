...
public class iv implements Creator {
    static void a(a aVar, Parcel parcel, int i) {
        ...
        if (hB.contains(Integer.valueOf(GoogleScorer.CLIENT_PLUS))) {
            b.c(parcel, GoogleScorer.CLIENT_PLUS, aVar.getLeftImageOffset());
        }
        if (hB.contains(Integer.valueOf(IabHelper.BILLING_RESPONSE_RESULT_BILLING_UNAVAILABLE))) {
            b.c(parcel, IabHelper.BILLING_RESPONSE_RESULT_BILLING_UNAVAILABLE, aVar.getTopImageOffset());
        }
        b.D(parcel, p);
    }
