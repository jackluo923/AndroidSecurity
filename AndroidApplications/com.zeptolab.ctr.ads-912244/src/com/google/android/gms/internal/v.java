...
public final class v extends com.google.android.gms.internal.ag.a implements ap, az, br, bu, com.google.android.gms.internal.by.a, u {
    ...
    public static final class a {
        ...
        public a(Context context, ab abVar, String str, db dbVar) {
            ...
            if (abVar.lo) {
                ...
                this.kK.setVisibility(GoogleScorer.CLIENT_APPSTATE);
            }
            this.kQ = abVar;
            this.adUnitId = str;
            this.kL = context;
        ...
        public void a_(HashSet hashSet) {
            this.kV = hashSet;
        }
    ...
    private com.google.android.gms.internal.cd.a c(z zVar) {
        ...
        if (this.kI.kQ.lo || this.kI.kK.getParent() == null) {
            ...
            i = (!this.kI.kK.isShown() || i2 + width <= 0 || i3 + height <= 0 || i2 > displayMetrics.widthPixels || i3 > displayMetrics.heightPixels) ? 0 : 1;
            bundle = new Bundle(5);
            bundle.putInt("x", i2);
            bundle.putInt("y", i3);
    ...
    public void a(cn cnVar) {
        ...
        if (cnVar.errorCode != -1) {
            boolean z;
            z = cnVar.oc.extras != null ? cnVar.oc.extras.getBoolean("_noRefresh", false) : false;
            if (this.kI.kQ.lo) {
                cv.a(cnVar.nu);
            } else if (!z) {
                if (cnVar.mx > 0) {
    ...
    public void onAppEvent(String str, String str2) {
        if (this.kI.kT != null) {
            try {
                this.kI.kT.onAppEvent(str, str2);
            } catch (RemoteException e) {
