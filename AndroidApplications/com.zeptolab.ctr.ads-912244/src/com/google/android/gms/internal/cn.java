...
public final class cn {
    ...
    public cn(z zVar, dd ddVar, List list, int i, List list2, List list3, int i2, long j, String str, boolean z, ax axVar, bg bgVar, String str2, ay ayVar, ba baVar, long j2, ab abVar, long j3, long j4, long j5) {
        this.oc = zVar;
        this.nu = ddVar;
