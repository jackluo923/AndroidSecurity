...
public final class ae {
    ...
    public ae(Context context, AttributeSet attributeSet) {
        ...
        this.ls = obtainAttributes.getString(GoogleScorer.CLIENT_PLUS);
    ...
    private static AdSize[] f(String str) {
        ...
        while (i < split.length) {
            ...
            if (trim.matches("^(\\d+|FULL_WIDTH)\\s*[xX]\\s*(\\d+|AUTO_HEIGHT)$")) {
                ...
                try {
                    adSizeArr[i] = new AdSize("FULL_WIDTH".equals(split2[0]) ? -1 : Integer.parseInt(split2[0]), "AUTO_HEIGHT".equals(split2[1]) ? ConfigException.MISSING_ACTIVITY_DECLARATION : Integer.parseInt(split2[1]));
