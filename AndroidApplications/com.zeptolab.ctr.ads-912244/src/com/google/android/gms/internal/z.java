...
public final class z implements SafeParcelable {
    ...
    z(int i, long j, Bundle bundle, int i2, List list, boolean z, int i3, boolean z2, String str, am amVar, Location location, String str2) {
        this.versionCode = i;
        this.le = j;
        this.extras = bundle;
        this.lf = i2;
    ...
    public z(Context context, aj ajVar) {
        ...
        this.lg = keywords.isEmpty() ? null : Collections.unmodifiableList(new ArrayList(keywords));
