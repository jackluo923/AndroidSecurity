...
public interface if_ extends IInterface {

    public static abstract class a extends Binder implements if_ {

        private static class a implements if_ {
            private IBinder ky;
            ...
            public void a_(int i, Bundle bundle, int i2, Intent intent) {
        ...
        public static if_ av(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.panorama.internal.IPanoramaCallbacks");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof if_)) ? new a(iBinder) : (if_) queryLocalInterface;
        }
    ...
    void a(int i, Bundle bundle, int i2, Intent intent);
}