...
public final class GooglePlayServicesUtil {
    ...
    private static int F(int i) {
        return i == -1 ? GoogleScorer.CLIENT_PLUS : i;
    }
    ...
    public static Dialog a(int i, Activity activity, int i2, OnCancelListener onCancelListener, int i3) {
        ...
        switch (i) {
            ...
            case com.zeptolab.ctr.ads.R.styleable.MapAttrs_uiZoomControls:
                Log.e("GooglePlayServicesUtil", "Developer error occurred. Please see logs for detailed information");
                return message.create();
            case com.zeptolab.ctr.ads.R.styleable.MapAttrs_uiZoomGestures:
                Log.e("GooglePlayServicesUtil", "The application is not licensed to the user.");
                return message.create();
            case com.zeptolab.ctr.ads.R.styleable.MapAttrs_useViewLifecycle:
    ...
    public static Intent a(Context context, int i, int i2) {
        switch (i) {
            ...
            case GoogleScorer.CLIENT_PLUS:
                if (!E(i2)) {
                    return ek.ah(GOOGLE_PLAY_SERVICES_PACKAGE);
                }
                return u(context) ? ek.ai(GOOGLE_PLAY_SERVICES_PACKAGE) : ek.ah("com.google.android.apps.bazaar");
            case IabHelper.BILLING_RESPONSE_RESULT_BILLING_UNAVAILABLE:
    ...
    public static boolean a(Resources resources) {
        ...
        return (fr.eJ() && ((resources.getConfiguration().screenLayout & 15) > 3) != 0) || b(resources);
    }
            ...
            if (packageInfo.signatures.length != 1) {
                ...
                try {
                    try {
                        ...
                        while (i < bArr.length) {
                            byte[] bArr3 = bArr[i];
                            if (Arrays.equals(bArr3, toByteArray)) {
                                return bArr3;
                            }
                            i++;
                        }
                        if (Log.isLoggable("GooglePlayServicesUtil", GoogleScorer.CLIENT_PLUS)) {
    ...
    public static Dialog getErrorDialog(int i, Activity activity, int i2) {
        return a(i, activity, i2, null, -1);
    }

    public static Dialog getErrorDialog(int i, Activity activity, int i2, OnCancelListener onCancelListener) {
        return a(i, activity, i2, onCancelListener, -1);
    }

    public static PendingIntent getErrorPendingIntent(int i, Context context, int i2) {
        Intent a = a(context, i, -1);
        return a == null ? null : PendingIntent.getActivity(context, i2, a, DriveFile.MODE_READ_ONLY);
    }
    ...
    public static Context getRemoteContext(Context context) {
        try {
            return context.createPackageContext(GOOGLE_PLAY_SERVICES_PACKAGE, IabHelper.BILLING_RESPONSE_RESULT_BILLING_UNAVAILABLE);
    ...
    public static int isGooglePlayServicesAvailable(Context context) {
        ...
        if (System.currentTimeMillis() < 1227312000288L) {
            return com.zeptolab.ctr.ads.R.styleable.MapAttrs_useViewLifecycle;
        }
        t(context);
        try {
            PackageInfo packageInfo = packageManager.getPackageInfo(GOOGLE_PLAY_SERVICES_PACKAGE, AccessibilityNodeInfoCompat.ACTION_ACCESSIBILITY_FOCUS);
            try {
                if (a(packageManager.getPackageInfo(GOOGLE_PLAY_STORE_PACKAGE, AccessibilityNodeInfoCompat.ACTION_ACCESSIBILITY_FOCUS), yL) == null) {
                    Log.w("GooglePlayServicesUtil", "Google Play Store signature invalid.");
                    return ZBuildConfig.$minsdk;
                } else {
                    if (a(packageInfo, new byte[][]{bArr}) == null) {
                        Log.w("GooglePlayServicesUtil", "Google Play services signature invalid.");
                        return ZBuildConfig.$minsdk;
                    } else if (packageInfo.versionCode < 4323000) {
                        ...
                        try {
                            return packageManager.getApplicationInfo(GOOGLE_PLAY_SERVICES_PACKAGE, 0).enabled ? 0 : IabHelper.BILLING_RESPONSE_RESULT_BILLING_UNAVAILABLE;
                        } catch (NameNotFoundException e) {
    ...
    public static boolean showErrorDialogFragment(int i, Activity activity, int i2, OnCancelListener onCancelListener) {
        boolean z = false;
        Dialog errorDialog = getErrorDialog(i, activity, i2, onCancelListener);
        if (errorDialog == null) {
            return false;
        }
        try {
        ...
        if (z) {
            b.a(errorDialog, onCancelListener).show(((FragmentActivity) activity).getSupportFragmentManager(), GMS_ERROR_DIALOG);
        } else if (fr.eJ()) {
            ErrorDialogFragment.newInstance(errorDialog, onCancelListener).show(activity.getFragmentManager(), GMS_ERROR_DIALOG);
        } else {
    ...
    private static boolean u(Context context) {
        ...
        try {
            return a(context.getPackageManager().getPackageInfo("com.google.android.apps.bazaar", AccessibilityNodeInfoCompat.ACTION_ACCESSIBILITY_FOCUS), yR) != null;
        } catch (NameNotFoundException e) {
            return false;
        }
    }
