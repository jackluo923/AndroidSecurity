...
public class b {
    ...
    public static void a(Parcel parcel, int i, byte b) {
        b(parcel, i, GoogleScorer.CLIENT_APPSTATE);
        parcel.writeInt(b);
    }

    public static void a(Parcel parcel, int i, double d) {
        b(parcel, i, IabHelper.BILLING_RESPONSE_RESULT_ITEM_NOT_OWNED);
    ...
    private static void b_(Parcel parcel, int i, int i2) {
        if (i2 >= 65535) {
            parcel.writeInt(-65536 | i);
            parcel.writeInt(i2);
        } else {
    ...
    public static void b_(Parcel parcel, int i, List list, boolean z) {
        if (list != null) {
            int B = B(parcel, i);
            int size = list.size();
