...
public interface Person extends Freezable {
    ...
    public static interface AgeRange extends Freezable {
        int getMax();
    ...
    public static interface Cover extends Freezable {

        public static interface CoverInfo extends Freezable {
        ...
        public static interface CoverPhoto extends Freezable {
            int getHeight();
    ...
    public static interface Image extends Freezable {
        String getUrl();

        boolean hasUrl();
    }

    public static interface Name extends Freezable {
    ...
    public static interface Organizations extends Freezable {
    ...
    public static interface PlacesLived extends Freezable {
        String getValue();
    ...
    public static interface Urls extends Freezable {
