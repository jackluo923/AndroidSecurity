...
public class h implements Creator {
    static void a(CreateFileRequest createFileRequest, Parcel parcel, int i) {
        ...
        b.a(parcel, (int)GoogleScorer.CLIENT_PLUS, createFileRequest.Dt, i, false);
        b.a(parcel, (int)IabHelper.BILLING_RESPONSE_RESULT_BILLING_UNAVAILABLE, createFileRequest.Ds, i, false);
        b.a(parcel, (int)GoogleScorer.CLIENT_APPSTATE, createFileRequest.Dq, i, false);
        b.D(parcel, p);
    }
