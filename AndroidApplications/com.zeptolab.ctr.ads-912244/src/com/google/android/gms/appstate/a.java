...
public final class a implements AppState {
    ...
    static int a_(AppState appState) {
        return ep.hashCode(new Object[]{Integer.valueOf(appState.getKey()), appState.getLocalVersion(), appState.getLocalData(), Boolean.valueOf(appState.hasConflict()), appState.getConflictVersion(), appState.getConflictData()});
    }

    static boolean a_(AppState appState, AppState appState2) {
