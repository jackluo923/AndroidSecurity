...
public class AdTrackerConstants {
    ...
    public static final String IAT_LOGGING_TAG = "[InMobi]-[AdTracker]-4.4.1";
    ...
    public enum StatusCode {
        ...
        static {
            APP_ANALYTICS_UPLOAD_SUCCESS = new com.inmobi.commons.analytics.iat.impl.AdTrackerConstants.StatusCode("APP_ANALYTICS_UPLOAD_SUCCESS", 0);
            APP_CONTEXT_NULL = new com.inmobi.commons.analytics.iat.impl.AdTrackerConstants.StatusCode("APP_CONTEXT_NULL", 1);
            APP_ANALYTICS_PREVIOUSLY_UPLOADED = new com.inmobi.commons.analytics.iat.impl.AdTrackerConstants.StatusCode("APP_ANALYTICS_PREVIOUSLY_UPLOADED", 2);
            ODIN1_NULL = new com.inmobi.commons.analytics.iat.impl.AdTrackerConstants.StatusCode("ODIN1_NULL", 3);
            APP_ANALYTICS_UPLOAD_FAILURE = new com.inmobi.commons.analytics.iat.impl.AdTrackerConstants.StatusCode("APP_ANALYTICS_UPLOAD_FAILURE", 4);
            APP_NOT_CONNECTED = new com.inmobi.commons.analytics.iat.impl.AdTrackerConstants.StatusCode("APP_NOT_CONNECTED", 5);
            RELOAD_WEBVIEW_ERROR = new com.inmobi.commons.analytics.iat.impl.AdTrackerConstants.StatusCode("RELOAD_WEBVIEW_ERROR", 6);
            a = new com.inmobi.commons.analytics.iat.impl.AdTrackerConstants.StatusCode[]{APP_ANALYTICS_UPLOAD_SUCCESS, APP_CONTEXT_NULL, APP_ANALYTICS_PREVIOUSLY_UPLOADED, ODIN1_NULL, APP_ANALYTICS_UPLOAD_FAILURE, APP_NOT_CONNECTED, RELOAD_WEBVIEW_ERROR};
        }
    }
}