...
class Assets {
    ...
    private static final String b = "mraid-assets-version";
    private static final int c = 4;
    private static Assets d;
    private String e;
    ...
    private void a(CircuitBreaker circuitBreaker, String str, String str2) {
        a(circuitBreaker, Base64.decode(str), str2);
    }
    ...
    protected static void a(Assets assets) {
        d = assets;
    }

    private boolean c() {
        CircuitBreaker circuitBreaker = new CircuitBreaker();
        a(circuitBreaker, AssetsBase64.BASE64_CLOSE_NORMAL, getFilePath(CLOSE_NORMAL));
        a(circuitBreaker, AssetsBase64.BASE64_CLOSE_PRESSED, getFilePath(CLOSE_PRESSED));
        a(circuitBreaker, AssetsBase64.BASE64_CLOSE, getFilePath(CLOSE));
        a(circuitBreaker, AssetsBase64.BASE64_LEFT_ARROW, getFilePath(LEFT_ARROW));
        a(circuitBreaker, AssetsBase64.BASE64_REFRESH, getFilePath(REFRESH));
        a(circuitBreaker, AssetsBase64.BASE64_RIGHT_ARROW, getFilePath(RIGHT_ARROW));
        a(circuitBreaker, AssetsBase64.BASE64_INTERSTITIAL_CLOSE_NORMAL, getFilePath(INTERSITIAL_CLOSE_NORMAL));
        a(circuitBreaker, AssetsBase64.BASE64_INTERSTITIAL_CLOSE_PRESSED, getFilePath(INTERSITIAL_CLOSE_PRESSED));
        a(circuitBreaker, AssetsBase64.BASE64_OPEN_EXTERNAL_BROWSER, getFilePath(OPEN_EXTERNAL_BROWSER));
        return !circuitBreaker.b();
    }
    ...
    protected String b() {
        return (InternalAdRegistration.getInstance() == null || InternalAdRegistration.getInstance().getFilesDir() == null) ? null : InternalAdRegistration.getInstance().getFilesDir().getAbsolutePath() + File.separator;
    }
    ...
    L_0x0008:
        r2 = r10.b();	 Catch:{ all -> 0x006d }
        r10.e = r2;	 Catch:{ all -> 0x006d }
        r2 = r10.e;	 Catch:{ all -> 0x006d }
        if (r2 != 0) goto L_0x0014;
    L_0x0012:
        monitor-exit(r10);
        return r0;
    L_0x0014:
        r2 = java.lang.System.nanoTime();	 Catch:{ all -> 0x006d }
        r4 = com.amazon.device.ads.Settings.getInstance();	 Catch:{ all -> 0x006d }
        r5 = "mraid-assets-version";
        r6 = 0;
        r5 = r4.getInt(r5, r6);	 Catch:{ all -> 0x006d }
        if (r5 >= r7) goto L_0x0044;
    L_0x0025:
        r5 = "Assets";
        r6 = "Writing assets to disk: version %d";
        r7 = 1;
        r7 = new java.lang.Object[r7];	 Catch:{ all -> 0x006d }
        r8 = 0;
        r9 = 4;
        r9 = java.lang.Integer.valueOf(r9);	 Catch:{ all -> 0x006d }
        r7[r8] = r9;	 Catch:{ all -> 0x006d }
        com.amazon.device.ads.Log.d(r5, r6, r7);	 Catch:{ all -> 0x006d }
        r5 = r10.c();	 Catch:{ all -> 0x006d }
        if (r5 == 0) goto L_0x005f;
    L_0x003d:
        r0 = "mraid-assets-version";
        r5 = 4;
        r4.putInt(r0, r5);	 Catch:{ all -> 0x006d }
        r0 = r1;
    L_0x0044:
        r4 = java.lang.System.nanoTime();	 Catch:{ all -> 0x006d }
        r2 = r4 - r2;
        r2 = com.amazon.device.ads.Utils.convertToMillisecondsFromNanoseconds(r2);	 Catch:{ all -> 0x006d }
        r4 = com.amazon.device.ads.Metrics.getInstance();	 Catch:{ all -> 0x006d }
        r4 = r4.getMetricsCollector();	 Catch:{ all -> 0x006d }
        if (r0 == 0) goto L_0x0070;
    L_0x0058:
        r0 = com.amazon.device.ads.Metrics.MetricType.ASSETS_CREATED_LATENCY;	 Catch:{ all -> 0x006d }
    L_0x005a:
        r4.publishMetricInMilliseconds(r0, r2);	 Catch:{ all -> 0x006d }
        r0 = r1;
        goto L_0x0012;
    L_0x005f:
        r1 = com.amazon.device.ads.Metrics.getInstance();	 Catch:{ all -> 0x006d }
        r1 = r1.getMetricsCollector();	 Catch:{ all -> 0x006d }
        r2 = com.amazon.device.ads.Metrics.MetricType.ASSETS_FAILED;	 Catch:{ all -> 0x006d }
        r1.incrementMetric(r2);	 Catch:{ all -> 0x006d }
        goto L_0x0012;
    L_0x006d:
        r0 = move-exception;
        monitor-exit(r10);
        throw r0;
    L_0x0070:
        r0 = com.amazon.device.ads.Metrics.MetricType.ASSETS_ENSURED_LATENCY;	 Catch:{ all -> 0x006d }
        goto L_0x005a;
        */
    }
