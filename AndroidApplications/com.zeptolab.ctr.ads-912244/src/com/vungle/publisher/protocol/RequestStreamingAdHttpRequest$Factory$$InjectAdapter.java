...
public final class RequestStreamingAdHttpRequest$Factory$$InjectAdapter extends b implements a.b, Provider {
    private b a;
    private b b;
    ...
    public final void attach(l lVar) {
        this.a = lVar.a("com.vungle.publisher.protocol.message.RequestStreamingAd$Factory", (Object)Factory.class, getClass().getClassLoader());
    ...
    public final void injectMembers(Factory factory) {
        factory.f = (RequestStreamingAd.Factory) this.a.get();
