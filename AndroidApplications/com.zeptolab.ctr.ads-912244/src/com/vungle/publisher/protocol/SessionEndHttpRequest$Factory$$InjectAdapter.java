...
public final class SessionEndHttpRequest$Factory$$InjectAdapter extends b implements a.b, Provider {
    private b a;
    private b b;
    ...
    public final void attach(l lVar) {
        this.a = lVar.a("com.vungle.publisher.protocol.message.SessionEnd$Factory", (Object)Factory.class, getClass().getClassLoader());
    ...
    public final void injectMembers(Factory factory) {
        factory.f = (SessionEnd.Factory) this.a.get();
