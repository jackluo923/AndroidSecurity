...
class TransportMediatorJellybeanMR2 implements OnGetPlaybackPositionListener, OnPlaybackPositionUpdateListener {
    ...
    public TransportMediatorJellybeanMR2(Context context, AudioManager audioManager, View view, TransportMediatorCallback transportMediatorCallback) {
        this.mWindowAttachListener = new OnWindowAttachListener() {
        ...
        this.mWindowFocusListener = new OnWindowFocusChangeListener() {
    ...
    public void pausePlaying() {
        if (this.mPlayState == 3) {
            this.mPlayState = 2;
            this.mRemoteControl.setPlaybackState(GoogleScorer.CLIENT_PLUS);
        }
        dropAudioFocus();
    }
    ...
    public void refreshState(boolean z, long j, int i) {
        if (this.mRemoteControl != null) {
            this.mRemoteControl.setPlaybackState(z ? 3 : 1, j, z ? 1.0f : BitmapDescriptorFactory.HUE_RED);
    ...
    public void startPlaying() {
        if (this.mPlayState != 3) {
            this.mPlayState = 3;
            this.mRemoteControl.setPlaybackState(IabHelper.BILLING_RESPONSE_RESULT_BILLING_UNAVAILABLE);
        }
        if (this.mFocused) {
            takeAudioFocus();
        }
    ...
    void takeAudioFocus() {
        if (!this.mAudioFocused) {
            ...
            this.mAudioManager.requestAudioFocus(this.mAudioFocusChangeListener, IabHelper.BILLING_RESPONSE_RESULT_BILLING_UNAVAILABLE, 1);
        }
    }
