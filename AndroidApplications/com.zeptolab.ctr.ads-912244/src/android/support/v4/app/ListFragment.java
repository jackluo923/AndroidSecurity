...
public class ListFragment extends Fragment {
        ...
        if (this.mList == null) {
            ...
            if (view instanceof ListView) {
                ...
                if (this.mStandardEmptyView == null) {
                    ...
                    this.mStandardEmptyView.setVisibility(IabHelper.BILLING_RESPONSE_RESULT_ITEM_NOT_OWNED);
                }
    ...
    private void setListShown(boolean z, boolean z2) {
        ...
        if (this.mProgressContainer == null) {
            ...
            if (z) {
                ...
                this.mProgressContainer.setVisibility(IabHelper.BILLING_RESPONSE_RESULT_ITEM_NOT_OWNED);
                ...
                this.mListContainer.setVisibility(IabHelper.BILLING_RESPONSE_RESULT_ITEM_NOT_OWNED);
            }
        }
    }
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        linearLayout.setGravity(ZBuildConfig.$targetsdk);
