...
public class PagerTitleStrip extends ViewGroup implements Decor {
    ...
    public PagerTitleStrip(Context context, AttributeSet attributeSet) {
        ...
        this.mPageListener = new PageListener(null);
        ...
        if (obtainStyledAttributes.hasValue(GoogleScorer.CLIENT_PLUS)) {
            dimensionPixelSize = obtainStyledAttributes.getColor(GoogleScorer.CLIENT_PLUS, 0);
        ...
        this.mGravity = obtainStyledAttributes.getInteger(IabHelper.BILLING_RESPONSE_RESULT_BILLING_UNAVAILABLE, 80);
    ...
    void updateText(int i, PagerAdapter pagerAdapter) {
        ...
        count = pagerAdapter != null ? pagerAdapter.getCount() : 0;
        this.mUpdatingText = true;
        pageTitle = (i < 1 || pagerAdapter == null) ? null : pagerAdapter.getPageTitle(i - 1);
