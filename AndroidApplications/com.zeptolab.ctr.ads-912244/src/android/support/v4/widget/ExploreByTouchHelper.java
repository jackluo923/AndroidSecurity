...
public abstract class ExploreByTouchHelper extends AccessibilityDelegateCompat {
    ...
    private AccessibilityNodeInfoCompat createNodeForChild(int i) {
        ...
        if ((actions & 64) != 0) {
            ...
            if (this.mFocusedVirtualViewId == i) {
                ...
                obtain.addAction(AccessibilityNodeInfoCompat.ACTION_ACCESSIBILITY_FOCUS);
            }
    ...
    private boolean intersectVisibleToUser(Rect rect) {
        ...
        return this.mView.getLocalVisibleRect(this.mTempVisibleRect) ? rect.intersect(this.mTempVisibleRect) : false;
    }
    ...
    private boolean manageFocusForChild(int i, int i2, Bundle bundle) {
        switch (i2) {
            ...
            case Cast.MAX_NAMESPACE_LENGTH:
