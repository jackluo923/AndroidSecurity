...
public class SearchViewCompat {
    ...
    static class SearchViewCompatStubImpl implements SearchViewCompatImpl {
        ...
        public Object newOnCloseListener(android.support.v4.widget.SearchViewCompat.OnCloseListenerCompat onCloseListenerCompat) {
            return null;
        }

        public Object newOnQueryTextListener(android.support.v4.widget.SearchViewCompat.OnQueryTextListenerCompat onQueryTextListenerCompat) {
            return null;
        }
    ...
    static class SearchViewCompatHoneycombImpl extends SearchViewCompatStubImpl {
        ...
        public Object newOnCloseListener(android.support.v4.widget.SearchViewCompat.OnCloseListenerCompat onCloseListenerCompat) {
            return SearchViewCompatHoneycomb.newOnCloseListener(new AnonymousClass_2(onCloseListenerCompat));
        }

        public Object newOnQueryTextListener(android.support.v4.widget.SearchViewCompat.OnQueryTextListenerCompat onQueryTextListenerCompat) {
            return SearchViewCompatHoneycomb.newOnQueryTextListener(new AnonymousClass_1(onQueryTextListenerCompat));
        }
