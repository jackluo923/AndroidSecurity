...
public abstract class CursorAdapter extends BaseAdapter implements CursorFilterClient, Filterable {
    ...
    void init(Context context, Cursor cursor, int i) {
        ...
        this.mRowIDColumn = z ? cursor.getColumnIndexOrThrow(AnalyticsSQLiteHelper.GENERAL_ID) : -1;
        if ((i & 2) == 2) {
    ...
    public Cursor swapCursor(Cursor cursor) {
        ...
        if (cursor != null) {
            ...
            this.mRowIDColumn = cursor.getColumnIndexOrThrow(AnalyticsSQLiteHelper.GENERAL_ID);
