...
public class FileProvider extends ContentProvider {
    ...
    static class SimplePathStrategy implements PathStrategy {
        ...
        public File getFileForUri(Uri uri) {
            ...
            int indexOf = encodedPath.indexOf(ApiEventType.API_MRAID_PAUSE_VIDEO, 1);
        ...
        public Uri getUriForFile(File file) {
            try {
                ...
                return new Builder().scheme(AdDatabaseHelper.COLUMN_AD_CONTENT).authority(this.mAuthority).encodedPath(Uri.encode((String) entry.getKey()) + '/' + Uri.encode(path2.endsWith("/") ? canonicalPath.substring(path2.length()) : canonicalPath.substring(path2.length() + 1), "/")).build();
            } catch (IOException e) {
    ...
    private static PathStrategy parsePathStrategy(Context context, String str) {
        ...
        XmlResourceParser loadXmlMetaData = context.getPackageManager().resolveContentProvider(str, Cast.MAX_NAMESPACE_LENGTH).loadXmlMetaData(context.getPackageManager(), META_DATA_FILE_PROVIDER_PATHS);
    ...
    public String getType(Uri uri) {
        ...
        int lastIndexOf = fileForUri.getName().lastIndexOf(ApiEventType.API_MRAID_SEEK_VIDEO);
        if (lastIndexOf >= 0) {
    ...
    public Cursor query(Uri uri, ?[] Arr, String str, String[] strArr, String str2) {
        ...
        String[] strArr2 = new String[Arr.length];
