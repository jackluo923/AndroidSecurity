...
class DefaultTypeAdapters$DefaultTimeTypeAdapter
  implements JsonSerializer<Time>, JsonDeserializer<Time>
{
  ...
  {
    Time localTime = deserialize(paramJsonElement, paramType, paramJsonDeserializationContext);
    return localTime;
  }
    ...
    throws JsonParseException
  {
    ...
    //   21: aload 6
    //   23: aload 7
    //   25: invokespecial 52	com/google/kagegamesgson/JsonParseException:<init>	(Ljava/lang/String;)V
    //   28: aload 6
    //   30: athrow
    //   31: aload_0
    //   32: getfield 18	com/google/kagegamesgson/DefaultTypeAdapters$DefaultTimeTypeAdapter:format	Ljava/text/DateFormat;
    //   35: astore 6
    //   37: aload 6
    //   39: monitorenter
    //   40: aload_0
    //   41: getfield 18	com/google/kagegamesgson/DefaultTypeAdapters$DefaultTimeTypeAdapter:format	Ljava/text/DateFormat;
    //   44: astore 7
    //   46: aload_1
    //   47: invokevirtual 64	com/google/kagegamesgson/JsonElement:getAsString	()Ljava/lang/String;
    //   50: astore 8
    //   52: aload 7
    //   54: aload 8
    //   56: invokevirtual 39	java/text/DateFormat:parse	(Ljava/lang/String;)Ljava/util/Date;
    //   59: astore 4
    //   61: new 48	java/sql/Time
    //   64: astore 7
    //   66: aload 4
    //   68: invokevirtual 35	java/util/Date:getTime	()J
    //   71: lstore 8
    //   73: aload 7
    //   75: lload 8
    //   77: invokespecial 22	java/sql/Time:<init>	(J)V
    //   80: aload 6
    //   82: monitorexit
    //   83: aload 7
    //   85: areturn
    ...
    //   0	116	0	this	DefaultTimeTypeAdapter
  ...
  public JsonElement serialize(Object paramObject, Type paramType, JsonSerializationContext paramJsonSerializationContext)
  {
    ...
    JsonElement localJsonElement = serialize((Time)paramObject, paramType, paramJsonSerializationContext);
  ...
  public JsonElement serialize(Time paramTime, Type paramType, JsonSerializationContext paramJsonSerializationContext)
  {
    synchronized (format)
    {
      ...
      String str = ((DateFormat)localObject1).format(paramTime);
...
/* Location:
 * Qualified Name:     com.google.kagegamesgson.DefaultTypeAdapters.DefaultTimeTypeAdapter
