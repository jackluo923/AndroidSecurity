...
public class NewDogPetalAdapter
  extends BaseAdapter
{
  private FileInputStream fis;
  private Activity mActivity;
  int mGalleryItemBackground;
  ImageThreadLoader mImageLoader;
  private ImageView[] mImages;
  
  public NewDogPetalAdapter(Activity paramActivity)
  {
    ImageThreadLoader localImageThreadLoader = new kagegames/apps/DWBeta/ImageThreadLoader;
    localImageThreadLoader.<init>();
    mImageLoader = localImageThreadLoader;
  ...
  public boolean createReflectedImages(int paramInt1, int paramInt2)
  {
    ...
    for (bool1 = false;; k = 0)
    {
      ...
      localObject8 = ((DWGameState)localObject8).getNewDogObjectList();
      if (localObject8 != null) {
        break;
      }
      localObject8 = "NewDogPetalAdapter";
      localObject14 = "NewDogObjectList is Null";
    ...
    localObject9 = ((DWGameState)localObject9).getNewDogObjectList();
    ...
    for (;;)
    {
      ...
      localObject14 = ((DWGameState)localObject14).getNewDogObjectList();
      localObject1 = localObject14;
      localObject6 = i17;
      paramInt2 = ((List)localObject1).get(localObject6);
      paramInt2 = (NewDogObject)paramInt2;
  ...
  {
    NewDogObject localNewDogObject = getItem(paramInt);
    return localNewDogObject;
  }
  
  public NewDogObject getItem(int paramInt)
  {
    Object localObject = DWApplication.getInstance();
    localObject = ((DWApplication)localObject).getDWGameState();
    localObject = ((DWGameState)localObject).getNewDogObjectList();
    this = ((List)localObject).get(paramInt);
    this = (NewDogObject)this;
    return this;
  }
...
/* Location:
 * Qualified Name:     kagegames.apps.DWBeta.NewDogPetalAdapter
