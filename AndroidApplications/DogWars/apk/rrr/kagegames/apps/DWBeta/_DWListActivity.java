...
public abstract class _DWListActivity
  extends _MemEffListActivity
{
  Typeface mFace;
  PollManagerList mPollManagerList;
  ...
  public void UpdateUI()
  {
    ...
    for (;;)
    {
      ...
      if (localObject3 != null)
      {
        ...
        ((StatusBarView)localObject3).RefreshBitmaps();
        localObject3 = mStatusBarView;
  ...
  public void onDestroy()
  {
    ...
    for (;;)
    {
      localObject = mPollManagerList;
      if (localObject != null)
      {
        localObject = mPollManagerList;
        ((PollManagerList)localObject).cleanup();
      }
      localObject = null;
      mPollManagerList = ((PollManagerList)localObject);
      super.onDestroy();
      return;
      localObject = "DogWars";
  ...
  {
    super.onPause();
    Object localObject = mPollManagerList;
    if (localObject != null)
    {
      localObject = mPollManagerList;
      ((PollManagerList)localObject).pause();
    }
    localObject = "DogWars";
  ...
  public void onResume()
  {
    ...
    {
      localObject = mPollManagerList;
      ((PollManagerList)localObject).unpause();
    }
    super.onResume();
    localObject = "DogWars";
...
/* Location:
 * Qualified Name:     kagegames.apps.DWBeta._DWListActivity
