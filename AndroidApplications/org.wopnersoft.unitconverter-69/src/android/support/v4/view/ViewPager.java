...
public class ViewPager extends ViewGroup {
    ...
    private int a(int i, float f, int i2, int i3) {
        ...
        return Math.max(((aq) this.e.get(0)).b, Math.min(i, ((aq) this.e.get(this.e.size() - 1)).b));
    }
    ...
    private void a(aq aqVar, int i, aq aqVar2) {
        ...
        if (aqVar2 != null) {
            clientWidth = aqVar2.b;
            int i3;
            if (clientWidth < aqVar.b) {
                f2 = aqVar2.e + aqVar2.d + f;
                i3 = clientWidth + 1;
                i2 = 0;
                while (i3 <= aqVar.b && i2 < this.e.size()) {
                    aqVar3 = (aq) this.e.get(i2);
                    while (i3 > aqVar3.b && i2 < this.e.size() - 1) {
                        i2++;
                        aqVar3 = (aq) this.e.get(i2);
                    }
                    while (i3 < aqVar3.b) {
            ...
            } else if (clientWidth > aqVar.b) {
                i2 = this.e.size() - 1;
                f2 = aqVar2.e;
                i3 = clientWidth - 1;
                while (i3 >= aqVar.b && i2 >= 0) {
                    aqVar3 = (aq) this.e.get(i2);
                    while (i3 < aqVar3.b && i2 > 0) {
                        i2--;
                        aqVar3 = (aq) this.e.get(i2);
                    }
                    while (i3 > aqVar3.b) {
        ...
        float f3 = aqVar.e;
        i2 = aqVar.b - 1;
        this.s = aqVar.b == 0 ? aqVar.e : -3.4028235E38f;
        this.t = aqVar.b == count + -1 ? aqVar.e + aqVar.d - 1.0f : Float.MAX_VALUE;
        int i4 = i - 1;
        while (i4 >= 0) {
            aqVar3 = (aq) this.e.get(i4);
            f2 = f3;
            while (i2 > aqVar3.b) {
    ...
    private void a(MotionEvent motionEvent) {
        ...
        if (m.b(motionEvent, b) == this.J) {
            b = b == 0 ? 1 : 0;
            this.F = m.c(motionEvent, b);
            this.J = m.b(motionEvent, b);
            if (this.K != null) {
                this.K.clear();
            }
        }
    ...
    private void a(boolean z) {
        ...
        while (scrollX < this.e.size()) {
            aq aqVar = (aq) this.e.get(scrollX);
            if (aqVar.c) {
                aqVar.c = false;
                boolean z2 = true;
            }
    ...
    private void b(boolean z) {
        ...
        int i = 0;
        while (i < childCount) {
            x.a(getChildAt(i), z ? IcsLinearLayout.SHOW_DIVIDER_MIDDLE : 0, null);
            i++;
        }
    }
    ...
    private boolean b(float f) {
        ...
        aq aqVar = (aq) this.e.get(0);
        aq aqVar2 = (aq) this.e.get(this.e.size() - 1);
        boolean z3;
        if (aqVar.b != 0) {
    ...
    private aq h() {
        ...
        while (i2 < this.e.size()) {
            int i4;
            aq aqVar2;
            aq aqVar3 = (aq) this.e.get(i2);
            aq aqVar4;
            if (i3 != 0 || aqVar3.b == i + 1) {
                aqVar4 = aqVar3;
                i4 = i2;
                aqVar2 = aqVar4;
            } else {
                ...
                aqVar3.e = f2 + f3 + f;
                aqVar3.b = i + 1;
                aqVar3.d = this.h.getPageWidth(aqVar3.b);
                aqVar4 = aqVar3;
                i4 = i2 - 1;
                aqVar2 = aqVar4;
            }
    ...
    aq a(int i, int i2) {
        aq aqVar = new aq();
        aqVar.b = i;
        aqVar.a = this.h.instantiateItem(this, i);
        aqVar.d = this.h.getPageWidth(i);
    ...
    aq a(View view) {
        ...
        while (i < this.e.size()) {
            ...
            if (this.h.isViewFromObject(view, aqVar.a)) {
                return aqVar;
            }
            i++;
        }
    ...
    void a() {
        ...
        while (i2 < this.e.size()) {
            ...
            boolean z4;
            boolean z5;
            aq aqVar = (aq) this.e.get(i2);
            int itemPosition = this.h.getItemPosition(aqVar.a);
            if (itemPosition == -1) {
                i3 = i2;
                i2 = i4;
                i4 = i;
                ...
                this.h.destroyItem(this, aqVar.b, aqVar.a);
                if (this.i == aqVar.b) {
                    i3 = i2;
                    z4 = z2;
        ...
        if (i != 0) {
            ...
            i2 = 0;
            while (i2 < i4) {
                ar arVar = (ar) getChildAt(i2).getLayoutParams();
                if (!arVar.a) {
                    arVar.c = 0.0f;
                }
                i2++;
    ...
    void a(int i) {
        ...
        int i3;
        if (this.i != i) {
            i2 = this.i < i ? R.styleable.SherlockTheme_activatedBackgroundIndicator : R.styleable.SherlockTheme_actionModeCloseDrawable;
            aq b = b(this.i);
            this.i = i;
            aqVar = b;
            i3 = i2;
        ...
        if (this.h == null) {
            ...
            if (count != this.b) {
                ...
                throw new IllegalStateException("The application's PagerAdapter changed the adapter's contents without calling PagerAdapter#notifyDataSetChanged! Expected adapter item count: " + this.b + ", found: " + count + " Pager id: " + resourceName + " Pager class: " + getClass() + " Problematic adapter: " + this.h.getClass());
            } else {
                aq aqVar2;
                aq a;
                aq aqVar3;
                ...
                while (i4 < this.e.size()) {
                    aqVar2 = (aq) this.e.get(i4);
                    if (aqVar2.b >= this.i) {
                        if (aqVar2.b != this.i) goto L_0x033c;
                        break;
                    } else {
                        i4++;
                    }
                ...
                aqVar2 = null;
                a = (aqVar2 != null || count <= 0) ? aqVar2 : a(this.i, i4);
                if (a != null) {
                    float paddingLeft;
                    int i5 = i4 - 1;
                    aqVar2 = i5 >= 0 ? (aq) this.e.get(i5) : null;
                    int clientWidth = getClientWidth();
                    paddingLeft = clientWidth <= 0 ? 0.0f : 2.0f - a.d + ((float) getPaddingLeft()) / ((float) clientWidth);
                    float f = 0.0f;
                    int i6 = this.i - 1;
                    int i7 = i5;
                    i5 = i4;
                    ...
                    while (i6 >= 0) {
                        if (f < paddingLeft || i6 >= max) {
                            if (aqVar2 == null || i6 != aqVar2.b) {
                                f += a(i6, i4 + 1).d;
                                i5++;
                                aqVar2 = i4 >= 0 ? (aq) this.e.get(i4) : null;
                            } else {
                                f += aqVar2.d;
                                i4--;
                                aqVar2 = i4 >= 0 ? (aq) this.e.get(i4) : null;
                            ...
                            break;
                        } else if (i6 == aqVar2.b && !aqVar2.c) {
                            this.e.remove(i4);
                            this.h.destroyItem(this, i6, aqVar2.a);
                            i4--;
                            i5--;
                            aqVar2 = i4 >= 0 ? (aq) this.e.get(i4) : null;
                        }
                        ...
                        while (i6 < count) {
                            ...
                            if (paddingLeft < paddingRight || i6 <= min) {
                                if (aqVar2 == null || i6 != aqVar2.b) {
                                    aqVar2 = a(i6, i8);
                                    i8++;
                                    f2 = paddingLeft + aqVar2.d;
                                    aqVar3 = i8 < this.e.size() ? (aq) this.e.get(i8) : null;
                                    f3 = f2;
                                } else {
                                    i8++;
                                    f2 = paddingLeft + aqVar2.d;
                ...
                if (hasFocus()) {
                    ...
                    aqVar2 = findFocus != null ? b(findFocus) : null;
                    if (aqVar2 == null || aqVar2.b != this.i) {
                        i2 = 0;
                        while (i2 < getChildCount()) {
                            View childAt2 = getChildAt(i2);
                            aq a2 = a(childAt2);
                            if (a2 == null || a2.b != this.i || !childAt2.requestFocus(i)) {
                                i2++;
                            } else {
                                return;
                            }
    ...
    void a(int i, int i2, int i3) {
        if (getChildCount() == 0) {
            ...
            if (i4 == 0 && i5 == 0) {
                ...
                setScrollState(IcsLinearLayout.SHOW_DIVIDER_MIDDLE);
                int clientWidth = getClientWidth();
                ...
                if (abs > 0) {
                    ...
                    clientWidth = (int) (((((float) Math.abs(i4)) / ((((float) clientWidth) * this.h.getPageWidth(this.i)) + ((float) this.o))) + 1.0f) * 100.0f);
                }
    ...
    public boolean a(KeyEvent keyEvent) {
        ...
        switch (keyEvent.getKeyCode()) {
            case R.styleable.SherlockTheme_selectableItemBackground:
                return c((int)R.styleable.SherlockTheme_actionModeCloseDrawable);
            case R.styleable.SherlockTheme_windowContentOverlay:
                return c((int)R.styleable.SherlockTheme_activatedBackgroundIndicator);
            case R.styleable.SherlockTheme_windowActionBarOverlay:
                if (VERSION.SDK_INT < 11) {
                    return false;
                }
                if (f.a(keyEvent)) {
                    return c((int)IcsLinearLayout.SHOW_DIVIDER_MIDDLE);
                }
                return f.a(keyEvent, 1) ? c(1) : false;
            default:
                return false;
        }
    }
    ...
    protected int getChildDrawingOrder(int i, int i2) {
        ...
        return ((ar) ((View) this.ae.get(i2)).getLayoutParams()).f;
    }
        ...
        if (action == 3 || action == 1) {
            ...
            switch (action) {
                ...
                case IcsLinearLayout.SHOW_DIVIDER_MIDDLE:
                    action = this.J;
                    if (action != -1) {
                        action = m.a(motionEvent, action);
                        float c = m.c(motionEvent, action);
                        float f = c - this.F;
                        float abs = Math.abs(f);
                        float d = m.d(motionEvent, action);
    ...
    protected void onMeasure(int i, int i2) {
        ...
        while (i5 < childCount) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (arVar != null && arVar.a) {
                    ...
                    if (arVar.width != -2) {
                        i8 = 1073741824;
                        i3 = arVar.width != -1 ? arVar.width : paddingLeft;
                    } else {
                        i8 = i3;
                        i3 = paddingLeft;
                    }
        ...
        while (i4 < i3) {
            ...
            if (childAt2.getVisibility() != 8) {
                arVar = (ar) childAt2.getLayoutParams();
                if (arVar == null || !arVar.a) {
                    childAt2.measure(MeasureSpec.makeMeasureSpec((int) (arVar.c * ((float) paddingLeft)), 1073741824), this.v);
                }
            }
            i4++;
        }
        ...
        switch (motionEvent.getAction() & 255) {
            ...
            case IcsToast.LENGTH_LONG:
                if (this.A) {
                    ...
                    a = (int) s.a(velocityTracker, this.J);
                    this.y = true;
                    int clientWidth = getClientWidth();
                    int scrollX = getScrollX();
                    aq h = h();
                    a(a(h.b, ((((float) scrollX) / ((float) clientWidth)) - h.e) / h.d, a, (int) (m.c(motionEvent, m.a(motionEvent, this.J)) - this.H)), true, true, a);
                    this.J = -1;
                    i();
                    z = this.R.c() | this.Q.c();
                }
            ...
            case IcsLinearLayout.SHOW_DIVIDER_MIDDLE:
                ...
                if (this.A) {
                    z = false | b(m.c(motionEvent, m.a(motionEvent, this.J)));
                }
                break;
            case R.styleable.SherlockTheme_actionBarTabTextStyle:
                if (this.A) {
            ...
            case R.styleable.SherlockTheme_actionBarStyle:
                a = m.b(motionEvent);
                this.F = m.c(motionEvent, a);
                this.J = m.b(motionEvent, a);
                break;
            case R.styleable.SherlockTheme_actionBarSplitStyle:
                a(motionEvent);
                this.F = m.c(motionEvent, m.a(motionEvent, this.J));
                break;
        }
        if (z) {
            x.b(this);
    ...
    public void setAdapter(r rVar) {
        ...
        if (this.aa != null && rVar2 != rVar) {
            this.aa.a(rVar2, rVar);
        }
    }
    ...
    void setOnAdapterChangeListener(as asVar) {
        this.aa = asVar;
    }
