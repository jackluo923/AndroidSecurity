...
public class NavUtils {
    ...
    class NavUtilsImplBase implements NavUtilsImpl {
        ...
        public Intent getParentActivityIntent(Activity activity) {
            ...
            try {
                return NavUtils.getParentActivityName(activity, componentName) == null ? f.a(componentName) : new Intent().setComponent(componentName);
    ...
    public static Intent getParentActivityIntent(Context context, ComponentName componentName) {
        ...
        return getParentActivityName(context, componentName2) == null ? f.a(componentName2) : new Intent().setComponent(componentName2);
    }
    ...
    public static Intent getParentActivityIntent(Context context, Class cls) {
        ...
        return getParentActivityName(context, componentName) == null ? f.a(componentName) : new Intent().setComponent(componentName);
    }
