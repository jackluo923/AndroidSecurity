...
public class ListFragment extends Fragment {
        ...
        if (this.mList == null) {
            ...
            if (view instanceof ListView) {
                ...
                if (this.mStandardEmptyView == null) {
                    ...
                    this.mStandardEmptyView.setVisibility(MenuItem.SHOW_AS_ACTION_COLLAPSE_ACTION_VIEW);
                }
    ...
    private void setListShown(boolean z, boolean z2) {
        ...
        if (this.mProgressContainer == null) {
            ...
            if (z) {
                ...
                this.mProgressContainer.setVisibility(MenuItem.SHOW_AS_ACTION_COLLAPSE_ACTION_VIEW);
                ...
                this.mListContainer.setVisibility(MenuItem.SHOW_AS_ACTION_COLLAPSE_ACTION_VIEW);
            }
        }
    }
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        linearLayout.setGravity(R.styleable.SherlockTheme_actionModeCloseDrawable);
        ...
        textView.setGravity(R.styleable.SherlockTheme_actionModeCloseDrawable);
