...
public class ActionBarImpl extends ActionBar {
    ...
    public class ActionModeImpl extends ActionMode implements MenuBuilder.Callback {
        ...
        public void finish() {
            if (ActionBarImpl.this.mActionMode == this) {
                ...
                ActionBarImpl.this.mActionView.sendAccessibilityEvent(R.styleable.SherlockTheme_searchDropdownBackground);
    ...
    public ActionMode startActionMode(Callback callback) {
        ...
        this.mContextView.sendAccessibilityEvent(R.styleable.SherlockTheme_searchDropdownBackground);
