...
public class IcsSpinner extends IcsAbsSpinner implements OnClickListener {
    ...
    public IcsSpinner(Context context, AttributeSet attributeSet, int i) {
        ...
        int dimensionPixelOffset = obtainStyledAttributes.getDimensionPixelOffset(R.styleable.SherlockTheme_actionBarSplitStyle, 0);
        if (dimensionPixelOffset != 0) {
            dropdownPopup.setVerticalOffset(dimensionPixelOffset);
        }
        dimensionPixelOffset = obtainStyledAttributes.getDimensionPixelOffset(R.styleable.SherlockTheme_actionBarStyle, 0);
        if (dimensionPixelOffset != 0) {
            dropdownPopup.setHorizontalOffset(dimensionPixelOffset);
        }
        this.mPopup = dropdownPopup;
        this.mGravity = obtainStyledAttributes.getInt(0, R.styleable.SherlockTheme_actionModeCloseDrawable);
        this.mPopup.setPromptText(obtainStyledAttributes.getString(R.styleable.SherlockTheme_actionBarTabTextStyle));
