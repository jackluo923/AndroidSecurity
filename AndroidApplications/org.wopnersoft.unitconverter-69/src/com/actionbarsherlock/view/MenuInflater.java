...
public class MenuInflater {
    ...
    class MenuState {
        ...
        public void readGroup(AttributeSet attributeSet) {
            ...
            this.groupCategory = obtainStyledAttributes.getInt(R.styleable.SherlockTheme_actionBarTabTextStyle, defaultItemOrder);
            this.groupOrder = obtainStyledAttributes.getInt(ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_DEFAULT, defaultItemOrder);
            this.groupCheckable = obtainStyledAttributes.getInt(R.styleable.SherlockTheme_actionBarStyle, defaultItemOrder);
        ...
        public void readItem(AttributeSet attributeSet) {
            ...
            this.itemCategoryOrder = (obtainStyledAttributes.getInt(R.styleable.SherlockTheme_actionBarStyle, this.groupCategory) & -65536) | (obtainStyledAttributes.getInt(R.styleable.SherlockTheme_actionBarSplitStyle, this.groupOrder) & 65535);
            this.itemTitle = obtainStyledAttributes.getText(R.styleable.SherlockTheme_actionBarWidgetTheme);
            ...
            this.itemAlphabeticShortcut = getShortcut(obtainStyledAttributes.getString(R.styleable.SherlockTheme_actionBarDivider));
            this.itemNumericShortcut = getShortcut(obtainStyledAttributes.getString(R.styleable.SherlockTheme_actionBarItemBackground));
            if (obtainStyledAttributes.hasValue(R.styleable.SherlockTheme_actionMenuTextAppearance)) {
                this.itemCheckable = obtainStyledAttributes.getBoolean(R.styleable.SherlockTheme_actionMenuTextAppearance, defaultItemChecked) ? 1 : 0;
            } else {
                this.itemCheckable = this.groupCheckable;
            }
            this.itemChecked = obtainStyledAttributes.getBoolean(R.styleable.SherlockTheme_actionBarTabTextStyle, defaultItemChecked);
            ...
            obtainStyledAttributes.getValue(R.styleable.SherlockTheme_actionModeStyle, typedValue);
            this.itemShowAsAction = typedValue.type == 17 ? typedValue.data : -1;
            this.itemListenerMethodName = obtainStyledAttributes.getString(R.styleable.SherlockTheme_actionMenuTextColor);
            this.itemActionViewLayout = obtainStyledAttributes.getResourceId(R.styleable.SherlockTheme_actionModeCloseButtonStyle, defaultItemOrder);
            typedValue = new TypedValue();
            obtainStyledAttributes.getValue(R.styleable.SherlockTheme_actionModeBackground, typedValue);
