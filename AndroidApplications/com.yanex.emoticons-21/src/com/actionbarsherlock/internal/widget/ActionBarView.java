...
public class ActionBarView extends AbsActionBarView {
    ...
    public ActionBarView(Context context, AttributeSet attributeSet) {
        ...
        this.mNavigationMode = obtainStyledAttributes.getInt(FragmentManagerImpl.ANIM_STYLE_FADE_EXIT, DISPLAY_DEFAULT);
                ...
                switch (this.mNavigationMode) {
                    case DISPLAY_DEFAULT:
                        ...
                        if (view2 != null) {
                            ...
                            if (paddingLeft != 1) {
                                paddingTop2 = ((getRight() - getLeft()) - measuredWidth) / 2;
                                if (paddingTop2 >= paddingTop) {
                                    paddingTop2 = 3;
                                } else {
                                    if (paddingTop2 + measuredWidth > i5) {
                                        paddingLeft = FragmentManagerImpl.ANIM_STYLE_FADE_ENTER;
                                    }
                            ...
                            switch (paddingLeft) {
                                case Menu.CATEGORY_SHIFT:
                                    ...
                                    break;
                                case 48:
                                    positionChild = getPaddingTop() + i6;
                                    break;
                                case 80:
                                    positionChild = getHeight() - getPaddingBottom() - view2.getMeasuredHeight() - leftOffset;
                                    break;
                            }
                            view2.layout(paddingTop, positionChild, view2.getMeasuredWidth() + paddingTop, view2.getMeasuredHeight() + positionChild);
                        }
                    ...
                    case IcsToast.LENGTH_LONG:
                        if (this.mListNavLayout != null) {
                            ...
                            if (view != null) {
                                ...
                                i7 = (this.mContentHeight <= 0 || layoutParams.height == -2) ? Integer.MIN_VALUE : 1073741824;
