...
public class SearchView extends LinearLayout implements CollapsibleActionView {
    ...
    public SearchView(Context context, AttributeSet attributeSet) {
        ...
        this.mTextKeyListener = new OnKeyListener() {
            public boolean onKey(View view, int i, KeyEvent keyEvent) {
                ...
                if (SearchView.this.mQueryTextView.isEmpty() || !r.b(keyEvent)) {
                    return DBG;
                }
        ...
        setIconifiedByDefault(obtainStyledAttributes.getBoolean(FragmentManagerImpl.ANIM_STYLE_CLOSE_ENTER, true));
    ...
    private Intent createIntentFromSuggestion(Cursor cursor, int i, String str) {
        ...
        try {
            ...
            return createIntent(columnString, columnString2 == null ? uri : Uri.parse(columnString2), SuggestionsAdapter.getColumnString(cursor, "suggest_intent_extra_data"), SuggestionsAdapter.getColumnString(cursor, "suggest_intent_query"), i, str);
    ...
    private CharSequence getDecoratedHint(CharSequence charSequence) {
        ...
        spannableStringBuilder.setSpan(new ImageSpan(drawable), 1, IcsLinearLayout.SHOW_DIVIDER_MIDDLE, 33);
    ...
    private boolean onSuggestionsKey(View view, int i, KeyEvent keyEvent) {
        if (this.mSearchable == null || this.mSuggestionsAdapter == null || keyEvent.getAction() != 0 || !r.b(keyEvent)) {
            return DBG;
        }
        if (i == 66 || i == 84 || i == 61) {
