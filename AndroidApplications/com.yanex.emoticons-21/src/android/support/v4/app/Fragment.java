...
public class Fragment implements ComponentCallbacks, OnCreateContextMenuListener {
    ...
    public static Fragment instantiate(Context context, String str, Bundle bundle) {
        try {
            ...
            throw new InstantiationException(new StringBuilder("Unable to instantiate fragment ").append(str).append(": make sure class name exists, is public, and has an empty constructor that is public").toString(), e3);
        }
    }
    ...
    public void setInitialSavedState(SavedState savedState) {
        ...
        Bundle bundle;
        bundle = (savedState == null || savedState.mState == null) ? null : savedState.mState;
