    ...
    public final BackStackRecord instantiate(FragmentManagerImpl fragmentManagerImpl) {
        ...
        while (i2 < this.mOps.length) {
            ...
            if (FragmentManagerImpl.DEBUG) {
                Log.v("FragmentManager", new StringBuilder("Instantiate ").append(backStackRecord).append(" op #").append(i).append(" base fragment #").append(this.mOps[i3]).toString());
            }
            int i4 = i3 + 1;
            i2 = this.mOps[i3];
            if (i2 >= 0) {
            ...
            if (i6 > 0) {
                ...
                while (i3 < i6) {
                    if (FragmentManagerImpl.DEBUG) {
                        Log.v("FragmentManager", new StringBuilder("Instantiate ").append(backStackRecord).append(" set remove fragment #").append(this.mOps[i4]).toString());
                    }
                    i5 = i4 + 1;
