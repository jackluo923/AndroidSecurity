...
public class FragmentActivity extends Activity {
    ...
    public View onCreateView(String str, Context context, AttributeSet attributeSet) {
        ...
        if (FragmentManagerImpl.DEBUG) {
            Log.v(TAG, new StringBuilder("onCreateView: id=0x").append(Integer.toHexString(resourceId)).append(" fname=").append(attributeValue).append(" existing=").append(fragment).toString());
        }
        if (fragment == null) {
    ...
    public boolean onPreparePanel(int i, View view, Menu menu) {
        ...
        return (super.onPreparePanel(i, view, menu) | this.mFragments.dispatchPrepareOptionsMenu(menu)) != 0 && menu.hasVisibleItems();
    }
