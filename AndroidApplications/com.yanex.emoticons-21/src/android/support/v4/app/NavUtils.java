...
public class NavUtils {
    ...
    class NavUtilsImplBase implements NavUtilsImpl {
        ...
        public Intent getParentActivityIntent(Activity activity) {
            ...
            try {
                return NavUtils.getParentActivityName(activity, componentName) == null ? d.a(componentName) : new Intent().setComponent(componentName);
            } catch (NameNotFoundException e) {
                Log.e(TAG, new StringBuilder("getParentActivityIntent: bad parentActivityName '").append(parentActivityName).append("' in manifest").toString());
                return null;
            }
        }
    ...
    public static Intent getParentActivityIntent(Context context, ComponentName componentName) {
        ...
        return getParentActivityName(context, componentName2) == null ? d.a(componentName2) : new Intent().setComponent(componentName2);
    }
    ...
    public static Intent getParentActivityIntent(Context context, Class cls) {
        ...
        return getParentActivityName(context, componentName) == null ? d.a(componentName) : new Intent().setComponent(componentName);
    }
