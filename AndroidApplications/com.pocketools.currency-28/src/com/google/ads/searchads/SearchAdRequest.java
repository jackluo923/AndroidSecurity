...
public class SearchAdRequest extends AdRequest {
    ...
    public enum BorderType {
        ...
        static {
            String str = "none";
            NONE = new com.google.ads.searchads.SearchAdRequest.BorderType("NONE", 0, "none");
            str = "dashed";
            DASHED = new com.google.ads.searchads.SearchAdRequest.BorderType("DASHED", 1, "dashed");
            str = "dotted";
            DOTTED = new com.google.ads.searchads.SearchAdRequest.BorderType("DOTTED", 2, "dotted");
            str = "solid";
            SOLID = new com.google.ads.searchads.SearchAdRequest.BorderType("SOLID", 3, "solid");
            b = new com.google.ads.searchads.SearchAdRequest.BorderType[]{NONE, DASHED, DOTTED, SOLID};
        }
