...
public class e {
    ...
    private boolean a(h hVar, String str) {
        ...
        b.c("GWController: ignoring callback to " + str + " from non showing ambassador with adapter class: '" + hVar.g() + "'.");
        return false;
    }

    private boolean a(String str, Activity activity, AdRequest adRequest, f fVar, HashMap<String, String> hashMap, long j) {
        h hVar = new h(this, (h) this.a.g().i.a(), fVar, str, adRequest, hashMap);
        synchronized (hVar) {
            hVar.a(activity);
            while (!hVar.c() && j > 0) {
                try {
            ...
            if (hVar.c() && hVar.d()) {
                this.a.a(new AnonymousClass_8(hVar, this.a.g().b() ? null : hVar.e(), fVar));
                return true;
            } else {
                hVar.b();
                return false;
    ...
    private void b(c cVar, AdRequest adRequest) {
        ...
        while (it.hasNext()) {
            ...
            List c = aVar.c();
            HashMap d = aVar.d();
            f fVar = new f(aVar.a(), aVar.b(), cVar.c(), cVar.g(), cVar.h(), cVar.i());
            Iterator it2 = c.iterator();
            while (it2.hasNext()) {
                String str = (String) it2.next();
                Activity activity = (Activity) this.a.g().c.a();
                if (activity == null) {
                    b.a("Activity is null while mediating.  Terminating mediation thread.");
                    return;
                } else if (!a(str, activity, adRequest, fVar, d, b)) {
                    if (d()) {
    ...
    public void a(h hVar, View view) {
        if (e() != hVar) {
            b.c("GWController: ignoring onAdRefreshed() callback from non-showing ambassador (adapter class name is '" + hVar.g() + "').");
        } else {
