...
public class a {
    ...
    static {
        a = Log.isLoggable("GoogleAdsAssertion", R.styleable.com_admob_android_ads_AdView_keywords);
    }
    ...
    private static void c(boolean z, String str) {
        if ((Log.isLoggable("GoogleAdsAssertion", R.styleable.com_admob_android_ads_AdView_keywords) || a) && !z) {
