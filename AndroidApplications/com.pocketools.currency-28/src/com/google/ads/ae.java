...
public final class ae {
            ...
            try {
                ...
                if (activity == null) {
                    ...
                    if (TextUtils.isEmpty(obj)) {
                        a.putString("drt", PocketCurrency.AD_MOB_KEYWORD_HINT);
                        a.putLong("drt_ts", 0);
                    } else {
                        a.putString("drt", obj);
    ...
    static boolean a(Context context, long j, SharedPreferences sharedPreferences) {
        return af.a(context) && (!sharedPreferences.contains("drt") || !sharedPreferences.contains("drt_ts") || sharedPreferences.getLong("drt_ts", 0) < new Date().getTime() - j);
    }
}