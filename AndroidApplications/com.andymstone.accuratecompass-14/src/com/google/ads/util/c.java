...
public class c {
    ...
    public class b extends com.google.ads.util.c.a {
                ...
                switch (i4) {
                    ...
                    case o.MyAlertDialog_MAD_titleStyle:
                        if (i7 >= 0) {
                            ...
                            bArr2[i6] = (byte) (i5 >> 10);
                            i6 += 2;
                            i7 = o.MyAlertDialog_MAD_textAppearanceMedium;
                        } else {
                            if (i7 != -1) {
                                this.e = 6;
                                return false;
    ...
    public class c extends com.google.ads.util.c.a {
...
*/
    ...
    public static byte[] b(byte[] bArr, int i, int i2, int i3) {
        ...
        if (cVar.e && i2 > 0) {
            i4 += (cVar.f ? o.MyAlertDialog_myAlertDialogButtonDrawable : 1) * (((i2 - 1) / 57) + 1);
        }
        cVar.a = new byte[i4];
