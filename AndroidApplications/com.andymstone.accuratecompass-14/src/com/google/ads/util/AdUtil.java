...
public final class AdUtil {
    ...
    public static int a() {
        return a >= 9 ? o.MyAlertDialog_MAD_divider : 0;
    }
    ...
    public static int a(String str) {
        try {
            ...
            return o.MyAlertDialog_MAD_titleStyle;
        }
    }
    ...
    public static int b() {
        return a >= 9 ? o.MyAlertDialog_MAD_edgePadding : 1;
    }
    ...
    public static String i(Context context) {
        if (i == null) {
            ...
            i = userAgentString + " (Mobile; " + "afma-sdk-a-v" + "6.2.1" + ")";
        }
        return i;
    }
}