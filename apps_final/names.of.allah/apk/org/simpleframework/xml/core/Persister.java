  ...
  implements Serializer
{
  ...
  {
    support = new Support(paramFilter, paramMatcher, paramFormat);
  ...
  {
    return (T)read(paramClass, paramInputNode, new Source(strategy, support, paramSession));
  }
  ...
  {
    return (T)read(paramT, paramInputNode, new Source(strategy, support, paramSession));
  }
  ...
  {
    return validate(paramClass, paramInputNode, new Source(strategy, support, paramSession));
  }
  ...
  {
    write(paramObject, paramOutputNode, new Source(strategy, support, paramSession));
  }
