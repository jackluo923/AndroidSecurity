...
class ExtractorFactory
{
  ...
  {
    Constructor localConstructor = ExtractorFactory.ExtractorBuilder.access$000(getBuilder(paramAnnotation));
    if (!localConstructor.isAccessible()) {
      localConstructor.setAccessible(true);
    }
    return localConstructor.newInstance(new Object[] { contact, paramAnnotation, format });
  }
