  ...
  implements Converter
{
  ...
  private Composite.Builder read(Schema paramSchema, Instance paramInstance)
  {
    if (paramSchema.getInstantiator().isDefault()) {
      return new Composite.Builder(this, criteria, paramSchema, paramInstance);
    }
    return new Composite.Injector(this, this, criteria, paramSchema, paramInstance, null);
  }
  ...
  private void readElement(InputNode paramInputNode, Object paramObject, Section paramSection, LabelMap paramLabelMap)
  {
    ...
    if (localLabel == null) {
      paramSection = criteria.resolve(str);
    }
  ...
  private void readUnion(InputNode paramInputNode, Object paramObject, LabelMap paramLabelMap, Label paramLabel)
  {
    ...
    if (paramLabel.isInline()) {
      criteria.set(paramLabel, paramInputNode);
    }
  }
  ...
  private Object readVariable(InputNode paramInputNode, Object paramObject, Label paramLabel)
  {
    ...
    {
      Variable localVariable = criteria.get(paramLabel);
  ...
  {
    if (paramObject != null) {
      paramLabel.getDecorator().decorate(paramOutputNode.setAttribute(paramLabel.getName(), factory.getText(paramObject)));
    }
  }
  ...
  private void writeElements(OutputNode paramOutputNode, Object paramObject, Section paramSection)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      else
      {
        ...
        Class localClass = context.getType(type, paramObject);
        if (criteria.get((Label)localObject) == null)
        {
          if (localObject == null) {
  ...
  private void writeVersion(OutputNode paramOutputNode, Object paramObject, Schema paramSchema)
  {
    ...
    if (paramObject != null)
    {
      ...
      if ((!revision.compare(paramObject, Double.valueOf(d))) || (paramSchema.isRequired())) {
  ...
  public void write(OutputNode paramOutputNode, Object paramObject)
  {
    // Byte code:
    //   0: aload_2
    //   1: invokevirtual 293	java/lang/Object:getClass	()Ljava/lang/Class;
    //   4: astore_3
    //   5: aload_0
    //   6: getfield 50	org/simpleframework/xml/core/Composite:context	Lorg/simpleframework/xml/core/Context;
    //   9: aload_3
    //   10: invokeinterface 86 2 0
    //   15: astore 4
    //   17: aload 4
    //   19: invokeinterface 92 1 0
    //   24: astore_3
    //   25: aload 4
    //   27: invokeinterface 583 1 0
    //   32: ifeq +18 -> 50
    //   35: aload_0
    //   36: getfield 38	org/simpleframework/xml/core/Composite:primitive	Lorg/simpleframework/xml/core/Primitive;
    //   39: aload_1
    //   40: aload_2
    //   41: invokevirtual 584	org/simpleframework/xml/core/Primitive:write	(Lorg/simpleframework/xml/stream/OutputNode;Ljava/lang/Object;)V
    //   44: aload_3
    //   45: aload_2
    //   46: invokevirtual 587	org/simpleframework/xml/core/Caller:complete	(Ljava/lang/Object;)V
    //   49: return
    //   50: aload_3
    //   51: aload_2
    //   52: invokevirtual 590	org/simpleframework/xml/core/Caller:persist	(Ljava/lang/Object;)V
    //   55: aload_0
    //   56: aload_1
    //   57: aload_2
    //   58: aload 4
    //   60: invokespecial 592	org/simpleframework/xml/core/Composite:write	(Lorg/simpleframework/xml/stream/OutputNode;Ljava/lang/Object;Lorg/simpleframework/xml/core/Schema;)V
    //   63: goto -19 -> 44
    //   66: astore_1
    //   67: aload_3
    //   68: aload_2
    //   69: invokevirtual 587	org/simpleframework/xml/core/Caller:complete	(Ljava/lang/Object;)V
    //   72: aload_1
    //   73: athrow
