...
.field mLoader:Landroid/support/v4/a/g;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
# virtual methods
.method final callOnLoadFinished(Landroid/support/v4/a/g;Ljava/lang/Object;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p2, v3}, Landroid/support/v4/c/d;->a(Ljava/lang/Object;Ljava/lang/StringBuilder;)V
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v4/app/LoaderManager$LoaderCallbacks;->onLoadFinished(Landroid/support/v4/a/g;Ljava/lang/Object;)V
    :try_end_0
...
.method final destroy()V
    ...
    iget-object v1, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Landroid/support/v4/a/g;
    ...
    iget-object v3, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Landroid/support/v4/a/g;

    invoke-interface {v0, v3}, Landroid/support/v4/app/LoaderManager$LoaderCallbacks;->onLoaderReset(Landroid/support/v4/a/g;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    iget-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Landroid/support/v4/a/g;
    ...
    iput-boolean v5, v0, Landroid/support/v4/a/g;->e:Z

    iput-boolean v4, v0, Landroid/support/v4/a/g;->c:Z

    iput-boolean v4, v0, Landroid/support/v4/a/g;->d:Z

    iput-boolean v4, v0, Landroid/support/v4/a/g;->f:Z

    iput-boolean v4, v0, Landroid/support/v4/a/g;->g:Z
...
.method public final dump(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-boolean v2, v0, Landroid/support/v4/a/g;->c:Z
    ...
    iget-boolean v1, v0, Landroid/support/v4/a/g;->d:Z
    ...
    iget-boolean v0, v0, Landroid/support/v4/a/g;->e:Z
...
.method final finishRetain()V
    ...
    invoke-virtual {p0, v0, v1}, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->callOnLoadFinished(Landroid/support/v4/a/g;Ljava/lang/Object;)V

    :cond_2
    return-void
.end method

.method public final onLoadComplete(Landroid/support/v4/a/g;Ljava/lang/Object;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v0, v0, Landroid/support/v4/app/LoaderManagerImpl;->mLoaders:Landroid/support/v4/c/m;
    ...
    iget-object v1, v1, Landroid/support/v4/app/LoaderManagerImpl;->mLoaders:Landroid/support/v4/c/m;
    ...
    invoke-virtual {p0, p1, p2}, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->callOnLoadFinished(Landroid/support/v4/a/g;Ljava/lang/Object;)V

    :cond_7
    iget-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->this$0:Landroid/support/v4/app/LoaderManagerImpl;

    iget-object v0, v0, Landroid/support/v4/app/LoaderManagerImpl;->mInactiveLoaders:Landroid/support/v4/c/m;
...
.method final start()V
    ...
    invoke-interface {v0, v1, v2}, Landroid/support/v4/app/LoaderManager$LoaderCallbacks;->onCreateLoader(ILandroid/os/Bundle;)Landroid/support/v4/a/g;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Landroid/support/v4/a/g;
    ...
    iget-object v2, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Landroid/support/v4/a/g;
    ...
    iput-boolean v3, v0, Landroid/support/v4/a/g;->c:Z
