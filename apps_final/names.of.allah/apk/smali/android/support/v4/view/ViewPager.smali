...
.field private static final sPositionComparator:Landroid/support/v4/view/bf;


# instance fields
.field private mActivePointerId:I

.field private mAdapter:Landroid/support/v4/view/aa;

.field private mAdapterChangeListener:Landroid/support/v4/view/ba;
...
.field private mInternalPageChangeListener:Landroid/support/v4/view/bb;
...
.field private mObserver:Landroid/support/v4/view/bd;

.field private mOffscreenPageLimit:I

.field private mOnPageChangeListener:Landroid/support/v4/view/bb;

.field private mPageMargin:I

.field private mPageTransformer:Landroid/support/v4/view/bc;
...
.field private final mTempItem:Landroid/support/v4/view/ax;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/view/ViewPager;->sPositionComparator:Landroid/support/v4/view/bf;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroid/support/v4/view/ViewPager;->mTempItem:Landroid/support/v4/view/ax;
...
.method static synthetic access$200(Landroid/support/v4/view/ViewPager;)Landroid/support/v4/view/aa;
    .locals 1
...
.method private calculatePageOffsets(Landroid/support/v4/view/ax;ILandroid/support/v4/view/ax;)V
    .locals 11
...
.method private infoForCurrentScrollPosition()Landroid/support/v4/view/ax;
    .locals 13
    ...
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->mTempItem:Landroid/support/v4/view/ax;
...
.method private pageScrolled(I)Z
    ...
    :cond_0
    invoke-direct {p0}, Landroid/support/v4/view/ViewPager;->infoForCurrentScrollPosition()Landroid/support/v4/view/ax;
...
.method private recomputeScrollPosition(IIII)V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v4/view/ViewPager;->infoForPosition(I)Landroid/support/v4/view/ax;
...
.method private scrollToItem(IZIZ)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v4/view/ViewPager;->infoForPosition(I)Landroid/support/v4/view/ax;
    ...
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->mOnPageChangeListener:Landroid/support/v4/view/bb;
    ...
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->mInternalPageChangeListener:Landroid/support/v4/view/bb;
    ...
    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->mOnPageChangeListener:Landroid/support/v4/view/bb;

    if-eqz v2, :cond_3

    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->mOnPageChangeListener:Landroid/support/v4/view/bb;

    invoke-interface {v2, p1}, Landroid/support/v4/view/bb;->a(I)V

    :cond_3
    if-eqz p4, :cond_4

    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->mInternalPageChangeListener:Landroid/support/v4/view/bb;
...
.method private setScrollState(I)V
    ...
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->mPageTransformer:Landroid/support/v4/view/bc;
...
.method private sortChildDrawingOrder()V
    ...
    sget-object v1, Landroid/support/v4/view/ViewPager;->sPositionComparator:Landroid/support/v4/view/bf;
...
.method public addFocusables(Ljava/util/ArrayList;II)V
    ...
    invoke-virtual {p0, v3}, Landroid/support/v4/view/ViewPager;->infoForChild(Landroid/view/View;)Landroid/support/v4/view/ax;
...
.method addNewItem(II)Landroid/support/v4/view/ax;
    .locals 2
...
.method public addTouchables(Ljava/util/ArrayList;)V
    ...
    invoke-virtual {p0, v1}, Landroid/support/v4/view/ViewPager;->infoForChild(Landroid/view/View;)Landroid/support/v4/view/ax;
...
.method protected getChildDrawingOrder(II)I
    ...
    iget v0, v0, Landroid/support/v4/view/ay;->f:I
...
.method infoForAnyChild(Landroid/view/View;)Landroid/support/v4/view/ax;
    .locals 2
    ...
    :cond_2
    invoke-virtual {p0, p1}, Landroid/support/v4/view/ViewPager;->infoForChild(Landroid/view/View;)Landroid/support/v4/view/ax;
...
.method infoForChild(Landroid/view/View;)Landroid/support/v4/view/ax;
    .locals 4
...
.method infoForPosition(I)Landroid/support/v4/view/ax;
    .locals 3
...
.method initViewPager()V
    ...
    invoke-static {p0, v4}, Landroid/support/v4/view/af;->b(Landroid/view/View;I)V
...
.method protected onLayout(ZIIII)V
    ...
    iget-boolean v10, v1, Landroid/support/v4/view/ay;->a:Z

    if-nez v10, :cond_2

    move-object/from16 v0, p0

    invoke-virtual {v0, v8}, Landroid/support/v4/view/ViewPager;->infoForChild(Landroid/view/View;)Landroid/support/v4/view/ax;
    ...
    iget-boolean v12, v1, Landroid/support/v4/view/ay;->d:Z

    if-eqz v12, :cond_1

    const/4 v12, 0x0

    iput-boolean v12, v1, Landroid/support/v4/view/ay;->d:Z
...
.method protected onPageScrolled(IFI)V
    ...
    iget-boolean v9, v0, Landroid/support/v4/view/ay;->a:Z
...
.method protected onRequestFocusInDescendants(ILandroid/graphics/Rect;)Z
    ...
    invoke-virtual {p0, v5}, Landroid/support/v4/view/ViewPager;->infoForChild(Landroid/view/View;)Landroid/support/v4/view/ax;
...
.method populate(I)V
    ...
    invoke-virtual {v0, v3}, Landroid/support/v4/view/ViewPager;->infoForPosition(I)Landroid/support/v4/view/ax;
    ...
    iget-object v5, v0, Landroid/support/v4/view/ViewPager;->mAdapter:Landroid/support/v4/view/aa;
    ...
    iget v7, v2, Landroid/support/v4/view/ax;->b:I
    ...
    invoke-virtual {v0, v2, v5}, Landroid/support/v4/view/ViewPager;->addNewItem(II)Landroid/support/v4/view/ax;
    ...
    iget v15, v2, Landroid/support/v4/view/ax;->b:I

    if-ne v9, v15, :cond_5

    iget-boolean v15, v2, Landroid/support/v4/view/ax;->c:Z
    ...
    iget-object v15, v0, Landroid/support/v4/view/ViewPager;->mAdapter:Landroid/support/v4/view/aa;

    iget-object v2, v2, Landroid/support/v4/view/ax;->a:Ljava/lang/Object;

    move-object/from16 v0, p0

    invoke-virtual {v15, v0, v9, v2}, Landroid/support/v4/view/aa;->destroyItem(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    iget v7, v10, Landroid/support/v4/view/ax;->d:F
    ...
    invoke-virtual {v0, v9, v2}, Landroid/support/v4/view/ViewPager;->addNewItem(II)Landroid/support/v4/view/ax;
    ...
    :cond_e
    iget v6, v10, Landroid/support/v4/view/ax;->d:F
    ...
    iget v11, v2, Landroid/support/v4/view/ax;->b:I

    if-ne v9, v11, :cond_1e

    iget-boolean v11, v2, Landroid/support/v4/view/ax;->c:Z
    ...
    iget-object v11, v0, Landroid/support/v4/view/ViewPager;->mAdapter:Landroid/support/v4/view/aa;

    iget-object v2, v2, Landroid/support/v4/view/ax;->a:Ljava/lang/Object;

    move-object/from16 v0, p0

    invoke-virtual {v11, v0, v9, v2}, Landroid/support/v4/view/aa;->destroyItem(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    invoke-virtual {v0, v9, v7}, Landroid/support/v4/view/ViewPager;->addNewItem(II)Landroid/support/v4/view/ax;
    ...
    invoke-direct {v0, v10, v8, v4}, Landroid/support/v4/view/ViewPager;->calculatePageOffsets(Landroid/support/v4/view/ax;ILandroid/support/v4/view/ax;)V
    ...
    iget-object v2, v10, Landroid/support/v4/view/ax;->a:Ljava/lang/Object;

    :goto_12
    move-object/from16 v0, p0

    invoke-virtual {v4, v0, v5, v2}, Landroid/support/v4/view/aa;->setPrimaryItem(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    iput v4, v2, Landroid/support/v4/view/ay;->f:I

    iget-boolean v7, v2, Landroid/support/v4/view/ay;->a:Z

    if-nez v7, :cond_18

    iget v7, v2, Landroid/support/v4/view/ay;->c:F
    ...
    invoke-virtual {v0, v6}, Landroid/support/v4/view/ViewPager;->infoForChild(Landroid/view/View;)Landroid/support/v4/view/ax;

    move-result-object v6

    if-eqz v6, :cond_18

    iget v7, v6, Landroid/support/v4/view/ax;->d:F

    iput v7, v2, Landroid/support/v4/view/ay;->c:F

    iget v6, v6, Landroid/support/v4/view/ax;->b:I

    iput v6, v2, Landroid/support/v4/view/ay;->e:I
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/view/ViewPager;->infoForAnyChild(Landroid/view/View;)Landroid/support/v4/view/ax;
    ...
    invoke-virtual {v0, v4}, Landroid/support/v4/view/ViewPager;->infoForChild(Landroid/view/View;)Landroid/support/v4/view/ax;
...
.method public setAdapter(Landroid/support/v4/view/aa;)V
    ...
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->mObserver:Landroid/support/v4/view/bd;
    ...
    iput-object v1, p0, Landroid/support/v4/view/ViewPager;->mObserver:Landroid/support/v4/view/bd;

    :cond_2
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Landroid/support/v4/view/aa;

    iget-object v3, p0, Landroid/support/v4/view/ViewPager;->mObserver:Landroid/support/v4/view/bd;
    ...
    :cond_3
    :goto_1
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->mAdapterChangeListener:Landroid/support/v4/view/ba;

    if-eqz v1, :cond_4

    if-eq v0, p1, :cond_4

    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->mAdapterChangeListener:Landroid/support/v4/view/ba;
...
.method setInternalPageChangeListener(Landroid/support/v4/view/bb;)Landroid/support/v4/view/bb;
    .locals 1

    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->mInternalPageChangeListener:Landroid/support/v4/view/bb;

    iput-object p1, p0, Landroid/support/v4/view/ViewPager;->mInternalPageChangeListener:Landroid/support/v4/view/bb;
...
.method setOnAdapterChangeListener(Landroid/support/v4/view/ba;)V
    ...
    iput-object p1, p0, Landroid/support/v4/view/ViewPager;->mAdapterChangeListener:Landroid/support/v4/view/ba;
...
.method public setOnPageChangeListener(Landroid/support/v4/view/bb;)V
    ...
    iput-object p1, p0, Landroid/support/v4/view/ViewPager;->mOnPageChangeListener:Landroid/support/v4/view/bb;
...
.method public setPageTransformer(ZLandroid/support/v4/view/bc;)V
    .locals 4
    ...
    :goto_0
    iget-object v3, p0, Landroid/support/v4/view/ViewPager;->mPageTransformer:Landroid/support/v4/view/bc;
    ...
    :goto_2
    iput-object p2, p0, Landroid/support/v4/view/ViewPager;->mPageTransformer:Landroid/support/v4/view/bc;
