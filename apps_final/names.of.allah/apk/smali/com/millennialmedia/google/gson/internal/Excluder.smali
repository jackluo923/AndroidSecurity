...
# virtual methods
.method protected final clone()Lcom/millennialmedia/google/gson/internal/Excluder;
    .locals 1
    ...
    check-cast v0, Lcom/millennialmedia/google/gson/internal/Excluder;
    :try_end_0
...
.method public final create(Lcom/millennialmedia/google/gson/Gson;Lcom/millennialmedia/google/gson/reflect/TypeToken;)Lcom/millennialmedia/google/gson/TypeAdapter;
    ...
    invoke-virtual {p0, v0, v1}, Lcom/millennialmedia/google/gson/internal/Excluder;->excludeClass(Ljava/lang/Class;Z)Z
...
.method public final disableInnerClassSerialization()Lcom/millennialmedia/google/gson/internal/Excluder;
    .locals 2
...
.method public final excludeClass(Ljava/lang/Class;Z)Z
    ...
    iget-wide v0, p0, Lcom/millennialmedia/google/gson/internal/Excluder;->version:D
    ...
    const-class v0, Lcom/millennialmedia/google/gson/annotations/Since;

    invoke-virtual {p1, v0}, Ljava/lang/Class;->getAnnotation(Ljava/lang/Class;)Ljava/lang/annotation/Annotation;

    move-result-object v0

    check-cast v0, Lcom/millennialmedia/google/gson/annotations/Since;

    const-class v1, Lcom/millennialmedia/google/gson/annotations/Until;

    invoke-virtual {p1, v1}, Ljava/lang/Class;->getAnnotation(Ljava/lang/Class;)Ljava/lang/annotation/Annotation;

    move-result-object v1

    check-cast v1, Lcom/millennialmedia/google/gson/annotations/Until;

    invoke-direct {p0, v0, v1}, Lcom/millennialmedia/google/gson/internal/Excluder;->isValidVersion(Lcom/millennialmedia/google/gson/annotations/Since;Lcom/millennialmedia/google/gson/annotations/Until;)Z
    ...
    :cond_0
    iget-boolean v0, p0, Lcom/millennialmedia/google/gson/internal/Excluder;->serializeInnerClasses:Z
    ...
    iget-object v0, p0, Lcom/millennialmedia/google/gson/internal/Excluder;->serializationStrategies:Ljava/util/List;
    ...
    :cond_4
    iget-object v0, p0, Lcom/millennialmedia/google/gson/internal/Excluder;->deserializationStrategies:Ljava/util/List;
...
.method public final excludeField(Ljava/lang/reflect/Field;Z)Z
    ...
    iget v0, p0, Lcom/millennialmedia/google/gson/internal/Excluder;->modifiers:I
    ...
    :cond_2
    iget-boolean v0, p0, Lcom/millennialmedia/google/gson/internal/Excluder;->requireExpose:Z

    if-eqz v0, :cond_5

    const-class v0, Lcom/millennialmedia/google/gson/annotations/Expose;
    ...
    invoke-direct {p0, v0}, Lcom/millennialmedia/google/gson/internal/Excluder;->isInnerClass(Ljava/lang/Class;)Z
    ...
    invoke-direct {p0, v0}, Lcom/millennialmedia/google/gson/internal/Excluder;->isAnonymousOrLocal(Ljava/lang/Class;)Z
    ...
    new-instance v1, Lcom/millennialmedia/google/gson/FieldAttributes;

    invoke-direct {v1, p1}, Lcom/millennialmedia/google/gson/FieldAttributes;-><init>(Ljava/lang/reflect/Field;)V
    ...
    invoke-interface {v0, v1}, Lcom/millennialmedia/google/gson/ExclusionStrategy;->shouldSkipField(Lcom/millennialmedia/google/gson/FieldAttributes;)Z
...
.method public final excludeFieldsWithoutExposeAnnotation()Lcom/millennialmedia/google/gson/internal/Excluder;
    .locals 2
...
.method public final withExclusionStrategy(Lcom/millennialmedia/google/gson/ExclusionStrategy;ZZ)Lcom/millennialmedia/google/gson/internal/Excluder;
    .locals 3
...
.method public final varargs withModifiers([I)Lcom/millennialmedia/google/gson/internal/Excluder;
    .locals 5
    ...
    iput v0, v1, Lcom/millennialmedia/google/gson/internal/Excluder;->modifiers:I
    ...
    iget v4, v1, Lcom/millennialmedia/google/gson/internal/Excluder;->modifiers:I

    or-int/2addr v3, v4

    iput v3, v1, Lcom/millennialmedia/google/gson/internal/Excluder;->modifiers:I
...
.method public final withVersion(D)Lcom/millennialmedia/google/gson/internal/Excluder;
    .locals 1
