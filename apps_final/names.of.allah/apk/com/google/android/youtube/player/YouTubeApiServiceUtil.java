...
public final class YouTubeApiServiceUtil
{
  ...
  private static boolean a(PackageInfo paramPackageInfo)
  {
    try
    {
      ((X509Certificate)CertificateFactory.getInstance("X509").generateCertificate(new ByteArrayInputStream(signatures[0].toByteArray()))).checkValidity();
...
/* Location:
 * Qualified Name:     com.google.android.youtube.player.YouTubeApiServiceUtil
