...
public final class GooglePlayServicesUtil
{
  ...
  public static int isGooglePlayServicesAvailable(Context paramContext)
  {
    ...
    catch (Throwable localThrowable)
    {
      ...
      {
        Log.w("GooglePlayServicesUtil", "Calling package " + packageName + " signature (test key) invalid on Glass.");
        return 9;
        label208:
        ...
        {
          Log.w("GooglePlayServicesUtil", "Calling package " + packageName + " signature (release key) invalid on Glass.");
          return 9;
          label301:
      ...
      int i = ij.aB(5077000);
      if (ij.aB(versionCode) < i)
      {
        Log.w("GooglePlayServicesUtil", "Google Play services out of date.  Requires 5077000 but found " + versionCode);
        return 2;
      }
      try
      {
