  ...
  extends AsyncTask<Void, Void, Integer>
{
  ...
  protected final Integer b(Void... paramVarArgs)
  {
    try
    {
  ...
  protected final void d(Integer paramInteger)
  {
    ...
    Intent localIntent = GooglePlayServicesUtil.Z(paramInteger.intValue());
    adY.onProviderInstallFailed(paramInteger.intValue(), localIntent);
  }
}
