  ...
  public WebResourceResponse shouldInterceptRequest(WebView paramWebView, String paramString)
  {
    try
    {
      ...
      if (Qmd)
      {
        ...
        return c(((ey)localObject).getContext(), lL.bY().st, "http://media.admob.com/mraid/v1/mraid_app_interstitial.js");
      }
      if (((ey)localObject).bZ())
      {
        ev.C("shouldInterceptRequest(http://media.admob.com/mraid/v1/mraid_app_expanded_banner.js)");
        return c(((ey)localObject).getContext(), lL.bY().st, "http://media.admob.com/mraid/v1/mraid_app_expanded_banner.js");
      }
      ev.C("shouldInterceptRequest(http://media.admob.com/mraid/v1/mraid_app_banner.js)");
      localObject = c(((ey)localObject).getContext(), lL.bY().st, "http://media.admob.com/mraid/v1/mraid_app_banner.js");
