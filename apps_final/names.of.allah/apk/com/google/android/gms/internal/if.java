  ...
  implements SafeParcelable
{
  ...
  {
    xJ = paramInt;
    Hn = ((Parcel)hn.f(paramParcel));
    Ho = 2;
    Hg = paramic;
    if (Hg == null) {}
    for (mClassName = null;; mClassName = Hg.fR())
    {
      Hp = 2;
      return;
    }
  ...
  private if(SafeParcelable paramSafeParcelable, ic paramic, String paramString)
  {
    xJ = 1;
    Hn = Parcel.obtain();
    paramSafeParcelable.writeToParcel(Hn, 0);
    Ho = 1;
    Hg = ((ic)hn.f(paramic));
    mClassName = ((String)hn.f(paramString));
    Hp = 2;
  }
  ...
  ic fU()
  {
    ...
    {
    default: 
      throw new IllegalStateException("Invalid creation type: " + Ho);
    case 0: 
      return null;
    case 1: 
      return Hg;
  ...
  {
    hn.b(Hg, "Cannot convert to JSON on client side.");
    Parcel localParcel = fT();
    localParcel.setDataPosition(0);
    StringBuilder localStringBuilder = new StringBuilder(100);
    a(localStringBuilder, Hg.aJ(mClassName), localParcel);
