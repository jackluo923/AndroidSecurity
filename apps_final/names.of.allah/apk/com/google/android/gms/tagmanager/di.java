  ...
  extends df
{
  ...
  {
    paramString = aer.get(paramString);
    if (paramString == null) {
      return null;
    }
  ...
  {
    Object localObject = aer.get("transactionProducts");
    if (localObject == null) {
      return null;
    }
  ...
  private Map<String, String> p(d.a parama)
  {
    ...
    if ((str != null) && (aiB.contains(str.toLowerCase()))) {
      parama.remove("&aip");
    }
    return parama;
  }
  ...
  {
    Tracker localTracker = aiC.cm("_GTM_DEFAULT_TRACKER_");
    if (e(paramMap, aiu))
    {
