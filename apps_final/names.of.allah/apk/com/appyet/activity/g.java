  ...
  extends WebChromeClient
{
  ...
  private DisqusCommentActivity g;
  private ProgressBar h;
  private final FrameLayout.LayoutParams i = new FrameLayout.LayoutParams(-1, -1, 17);
  
  public g(DisqusCommentActivity paramDisqusCommentActivity1, DisqusCommentActivity paramDisqusCommentActivity2)
  {
    g = paramDisqusCommentActivity2;
  ...
  public final void onProgressChanged(WebView paramWebView, int paramInt)
  {
    if (paramInt < 100)
    {
      DisqusCommentActivity.a(a).setVisibility(0);
      DisqusCommentActivity.a(a).setProgress(paramInt);
      return;
    }
    DisqusCommentActivity.a(a).setVisibility(8);
    DisqusCommentActivity.a(a).setProgress(0);
  }
...
/* Location:
 * Qualified Name:     com.appyet.activity.g
