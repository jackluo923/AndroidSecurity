...
public class InMobiAnalytics
{
  ...
  public static void reportCustomGoal(String paramString)
  {
    ...
    {
      Log.internal("[InMobi]-[Analytics]-4.4.1", "Unable to report custom goal due to unexpected exception.", paramString);
    }
  }
  ...
  public static void tagEvent(String paramString, Map<String, String> paramMap)
  {
    ...
    {
      Log.internal("[InMobi]-[Analytics]-4.4.1", "Unable to tag event due to unexpected exception.", paramString);
    }
  }
  ...
  public static void tagTransactionManually(Intent paramIntent, Bundle paramBundle)
  {
    ...
    {
      Log.internal("[InMobi]-[Analytics]-4.4.1", "Unable to tag transaction due to unexpected exception.", paramIntent);
    }
  }
}

/* Location:
 * Qualified Name:     com.inmobi.analytics.InMobiAnalytics
