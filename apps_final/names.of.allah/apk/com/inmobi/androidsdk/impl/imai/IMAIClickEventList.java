  ...
  extends ArrayList<ClickData>
{
  ...
  public ClickData getClickEvent(long paramLong)
  {
    ...
    {
      Log.internal("[InMobi]-[Network]-4.4.1", "Cant get click event", localException);
      return null;
    }
    return null;
  }
  ...
  public void reduceRetryCount(int paramInt)
  {
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        Log.internal("[InMobi]-[Network]-4.4.1", "Cant reduce retry count", localException);
      }
    }
    finally {}
  }
  ...
  public boolean removeClickEvent(long paramLong)
  {
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        Log.internal("[InMobi]-[Network]-4.4.1", "Cant remove click event", localException);
      }
    }
    finally {}
    return bool;
