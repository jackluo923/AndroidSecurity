...
final class IMAICore$b
  implements Runnable
{
  IMAICore$b(String paramString, boolean paramBoolean, WeakReference paramWeakReference) {}
  ...
  public final void run()
  {
    try
    {
      ...
      ClickData localClickData = new ClickData(a, b, true, i);
      ...
      localRequestResponseManager.processClick(InternalSDKUtil.getContext(), new IMAICore.b.a(this));
      return;
    }
...
/* Location:
 * Qualified Name:     com.inmobi.androidsdk.impl.imai.IMAICore.b
