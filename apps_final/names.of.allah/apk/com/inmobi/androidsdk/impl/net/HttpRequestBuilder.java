...
public final class HttpRequestBuilder
{
  private static String a(UserInfo paramUserInfo)
  {
    ...
    {
      Log.internal("[InMobi]-[Network]-4.4.1", "Couldn't build post string in IMHttpRequestBuilder", paramUserInfo);
    }
    return null;
  }
  ...
  private static String a(UserInfo paramUserInfo, WifiInfo paramWifiInfo)
  {
    ...
    do
    {
      ...
      if (paramWifiInfo != null) {
        localStringBuilder.append("&c-ap-bssid=" + bssid);
      }
      try
      {
        paramUserInfo = getCurrentCellTowergetContextid;
      ...
      catch (Exception paramUserInfo)
      {
        for (;;)
        {
          Log.internal("[InMobi]-[Network]-4.4.1", "Exception getting cell tower id", paramUserInfo);
        }
      }
  ...
  private static String b(UserInfo paramUserInfo)
  {
    try
    {
      ...
      ((StringBuilder)localObject).append("&u-id-adt=");
      if (InternalSDKUtil.isLimitAdTrackingEnabled()) {
        ((StringBuilder)localObject).append(1);
      }
      for (;;)
      {
        if (paramUserInfo.getPlainUidMap() != null)
        {
          ((StringBuilder)localObject).append("&u-id-map=");
          ((StringBuilder)localObject).append(getURLEncoded(paramUserInfo.getPlainUidMap()));
        }
        ...
        return ((String)localObject).substring(1);
  ...
  public static String buildPostBody(UserInfo paramUserInfo, WifiInfo paramWifiInfo, RequestResponseManager.ActionType paramActionType)
  {
    ...
    for (;;)
    {
      ...
      {
        Log.internal("[InMobi]-[Network]-4.4.1", "Exception occured in an ad request" + paramUserInfo);
        continue;
      }
