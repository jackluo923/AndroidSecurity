...
public final class WifiScanner
{
  ...
  private static void g()
  {
    if (i == null)
    {
      PowerManager.WakeLock localWakeLock = ((PowerManager)a.getSystemService("power")).newWakeLock(1, "wifiscanrequester.CpuLock");
      i = localWakeLock;
  ...
  private static void i()
  {
    if (j == null)
    {
      WifiManager.WifiLock localWifiLock = ((WifiManager)a.getSystemService("wifi")).createWifiLock(2, "wifiscanrequester.WiFiScanLock");
      j = localWifiLock;
      localWifiLock.setReferenceCounted(false);
    }
    if (!j.isHeld()) {
      j.acquire();
    }
  ...
  public static boolean requestScan(Looper paramLooper, Context paramContext, WifiScanListener paramWifiScanListener, long paramLong, boolean paramBoolean)
  {
    ...
    //   68: astore_0
    //   69: aload_0
    //   70: putstatic 31	com/inmobi/commons/thinICE/wifi/WifiScanner:c	Landroid/os/Handler;
    //   73: aload_0
