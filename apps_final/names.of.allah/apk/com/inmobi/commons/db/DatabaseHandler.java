  ...
  extends SQLiteOpenHelper
{
  ...
  public DatabaseHandler(Context paramContext, ArrayList<TableData> paramArrayList)
  {
  ...
  private void a(SQLiteDatabase paramSQLiteDatabase)
  {
    ...
    {
      Log.internal("[InMobi]-4.4.1", "Exception creating table", paramSQLiteDatabase);
    }
    ...
    for (Object localObject1 = ((StringBuilder)localObject2).substring(0, ((StringBuilder)localObject2).length() - 2);; localObject1 = ((StringBuilder)localObject2).toString())
    {
      ...
      Log.internal("[InMobi]-4.4.1", "Table: " + (String)localObject1);
  ...
  public void close()
  {
    ...
    {
      Log.internal("[InMobi]-4.4.1", "Failed to close  db", localException);
    }
  }
  ...
  public int delete(String paramString1, String paramString2, String[] paramArrayOfString)
  {
    try
    {
      m = b.delete(paramString1, paramString2, paramArrayOfString);
      return m;
    }
    catch (Exception paramString1)
    {
      for (;;)
      {
        Log.internal("[InMobi]-4.4.1", "Failed to insert to db", paramString1);
        int m = -1;
      }
    }
    finally {}
  ...
  public Cursor executeQuery(String paramString, String[] paramArrayOfString)
  {
    try
    {
      paramString = b.rawQuery(paramString, paramArrayOfString);
      return paramString;
    }
    catch (Exception paramString)
    {
      for (;;)
      {
        Log.internal("[InMobi]-4.4.1", "Failed to execute db query", paramString);
        paramString = null;
      }
    }
    finally {}
  ...
  public Cursor getAll(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramString1 = b.rawQuery(h + paramString1 + k, null);
        paramString1.moveToFirst();
      }
      catch (Exception paramString1)
      {
        Log.internal("[InMobi]-4.4.1", "Failed to all rows", paramString1);
        paramString1 = (String)localObject;
        continue;
      }
      finally {}
      return paramString1;
      paramString1 = b.rawQuery(h + paramString1 + j + paramString2 + k, null);
    }
  }
  ...
  public Cursor getNRows(String paramString1, String paramString2, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      return paramString1;
      paramString1 = b.rawQuery(h + paramString1 + j + paramString2 + l + k, new String[] { String.valueOf(paramInt) });
    }
  }
  ...
  public int getNoOfRows(String paramString1, String paramString2, String[] paramArrayOfString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramString1 = b.rawQuery(h + paramString1 + i + paramString2, paramArrayOfString);
        m = paramString1.getCount();
        paramString1.close();
      }
      catch (Exception paramString1)
      {
        Log.internal("[InMobi]-4.4.1", "Failed to get number of rows", paramString1);
        int m = 0;
        continue;
      }
      finally {}
  ...
  public Cursor getRow(String paramString1, String paramString2, String[] paramArrayOfString)
  {
    ...
    for (;;)
    {
      ...
      return paramString1;
      paramString1 = b.rawQuery(h + paramString1 + i + paramString2 + k, paramArrayOfString);
    }
  }
  ...
  protected int getTableSize(String paramString)
  {
    try
    {
      paramString = b.rawQuery(h + paramString + k, null);
    ...
    catch (Exception paramString)
    {
      for (;;)
      {
        Log.internal("[InMobi]-4.4.1", "Failed to table size ", paramString);
        int m = 0;
      }
    }
    finally {}
  ...
  public long insert(String paramString, ContentValues paramContentValues)
  {
    try
    {
      l1 = b.insert(paramString, null, paramContentValues);
      return l1;
    }
    catch (Exception paramString)
    {
      for (;;)
      {
        Log.internal("[InMobi]-4.4.1", "Failed to insert to db", paramString);
        long l1 = -1L;
      }
    }
    finally {}
  ...
  public void onUpgrade(SQLiteDatabase paramSQLiteDatabase, int paramInt1, int paramInt2)
  {
    ...
    {
      Log.internal("[InMobi]-4.4.1", "Exception Deleting table", paramSQLiteDatabase);
      return;
    }
  }
  ...
  public void open()
  {
    ...
    {
      Log.internal("[InMobi]-4.4.1", "Failed to open  db", localException);
    }
  }
  ...
  public long update(String paramString1, ContentValues paramContentValues, String paramString2, String[] paramArrayOfString)
  {
    try
    {
      int m = b.update(paramString1, paramContentValues, paramString2, paramArrayOfString);
      l1 = m;
    }
    catch (Exception paramString1)
    {
...
/* Location:
 * Qualified Name:     com.inmobi.commons.db.DatabaseHandler
