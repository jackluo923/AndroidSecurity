...
public class Base64
{
  ...
  public static byte[] decode(byte[] paramArrayOfByte, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    paramArrayOfByte = new byte[g];
    System.arraycopy(f, 0, paramArrayOfByte, 0, g);
  ...
  {
    Base64.a locala = new Base64.a(paramInt3, null);
    int i = paramInt2 / 3 * 4;
    int j;
    if (b)
    {
    ...
    for (i = 2;; i = 1)
    {
      i = paramInt3 + i * (j + 1);
      f = new byte[i];
      locala.a(paramArrayOfByte, paramInt1, paramInt2, true);
      if ((a) || (g == i)) {
        break label192;
      }
...
/* Location:
 * Qualified Name:     com.inmobi.commons.thirdparty.Base64
