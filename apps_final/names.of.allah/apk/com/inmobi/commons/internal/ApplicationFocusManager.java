...
public class ApplicationFocusManager
{
  ...
  private static void b()
  {
    for (;;)
    {
      ...
      try
      {
        Object localObject1 = new HandlerThread("InMobiAFM");
        ...
        else
        {
          ...
          localObject3 = new ApplicationFocusManager.a();
      ...
      catch (Exception localException)
      {
        ...
        Log.internal("[InMobi]-4.4.1", "Cannot register activity lifecycle callbacks", localException);
        return;
      }
      i += 1;
    }
  ...
  private static void c()
  {
    ...
    {
      localException.printStackTrace();
      Log.internal("[InMobi]-4.4.1", "Exception unregister app lifecycle callback", localException);
    }
  }
...
/* Location:
 * Qualified Name:     com.inmobi.commons.internal.ApplicationFocusManager
