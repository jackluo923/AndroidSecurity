...
public class AnalyticsPayloadBuilder
{
    ...
    for (;;)
    {
      if (paramList.hasNext())
      {
        ...
        for (;;)
        {
          ...
          {
            Log.internal("[InMobi]-[Analytics]-4.4.1", "Creation of events json object failed", localException1);
            continue;
          }
          try
          {
  ...
  private JSONObject a(String paramString, long paramLong, Context paramContext)
  {
    ...
    try
    {
      ...
      localJSONObject.put("sv", "4.4.1");
      localJSONObject.put("co", AnalyticsUtils.getCountryISO(paramContext));
      return localJSONObject;
    }
    catch (JSONException paramString)
    {
      Log.internal("[InMobi]-[Analytics]-4.4.1", "Creation of session object failed", paramString);
    }
    return localJSONObject;
  }
...
/* Location:
 * Qualified Name:     com.inmobi.commons.analytics.net.AnalyticsPayloadBuilder
