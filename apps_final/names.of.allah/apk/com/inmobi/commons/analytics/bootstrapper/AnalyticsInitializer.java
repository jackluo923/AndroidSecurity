...
public class AnalyticsInitializer
{
  ...
  private static void a(Context paramContext)
  {
    ...
    while ((a != null) || (paramContext != null)) {
      for (;;)
      {
        ...
        {
          Log.internal("[InMobi]-[Analytics]-4.4.1", "Exception while retreiving configs due to commons Exception with code " + paramContext.getCode());
          return;
        }
        catch (Exception paramContext)
        {
          Log.internal("[InMobi]-[Analytics]-4.4.1", "Exception while retreiving configs.", paramContext);
          return;
        }
      }
    }
  ...
  private static boolean b(Map<String, Object> paramMap)
  {
    ...
    {
      Log.internal("[InMobi]-[Analytics]-4.4.1", "Exception while saving configs.", paramMap);
    }
    return false;
  }
...
/* Location:
 * Qualified Name:     com.inmobi.commons.analytics.bootstrapper.AnalyticsInitializer
