  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    while ((!paramIntent.getAction().equals("android.net.conn.CONNECTIVITY_CHANGE")) || (!InternalSDKUtil.checkNetworkAvailibility(paramContext))) {
      try
      {
        ...
        Log.debug("[InMobi]-[AdTracker]-4.4.1", "Referrer String: " + paramIntent);
      ...
      {
        Log.internal("[InMobi]-[AdTracker]-4.4.1", "Error install receiver", paramContext);
        return;
      }
    }
    try
    ...
    {
      Log.internal("[InMobi]-[AdTracker]-4.4.1", "Connectivity receiver exception", paramContext);
    }
  }
}

/* Location:
 * Qualified Name:     com.inmobi.commons.analytics.androidsdk.IMAdTrackerReceiver
