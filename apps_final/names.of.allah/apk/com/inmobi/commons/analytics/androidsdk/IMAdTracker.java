...
public final class IMAdTracker
{
  ...
  private boolean a(String paramString)
  {
    try
    {
      String str = FileOperations.getPreferences(InternalSDKUtil.getContext(), "IMAdTrackerStatusUpload", "mk-siteid");
      ...
      if ("download".equals(paramString)) {
        if (!AdTrackerUtils.checkDownloadGoalAdded())
        {
          ...
          Log.debug("[InMobi]-[AdTracker]-4.4.1", "Goal Queued " + paramString);
    ...
    {
      Log.internal("[InMobi]-[AdTracker]-4.4.1", "Cannot report goal", paramString);
    }
  }
  ...
  public final void init(Context paramContext, String paramString)
  {
    ...
    {
      Log.internal("[InMobi]-[AdTracker]-4.4.1", "Failed to init", paramContext);
      return;
    }
    if (paramString == null)
    {
  ...
  public final void reportCustomGoal(String paramString)
  {
    if ("download".equals(paramString))
    {
...
/* Location:
 * Qualified Name:     com.inmobi.commons.analytics.androidsdk.IMAdTracker
