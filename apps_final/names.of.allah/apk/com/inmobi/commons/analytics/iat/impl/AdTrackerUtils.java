...
public class AdTrackerUtils
{
  ...
  public static String getReferrerFromLogs()
  {
    ...
    //   115: invokevirtual 127	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   118: invokestatic 27	com/inmobi/commons/internal/Log:internal	(Ljava/lang/String;Ljava/lang/String;)V
    //   121: aload_1
    //   122: areturn
    //   123: astore_0
    //   124: aconst_null
    ...
    //   128: ldc -127
    //   130: aload_0
    //   131: invokestatic 132	com/inmobi/commons/internal/Log:internal	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   134: aload_1
    //   135: areturn
    //   136: astore_0
    //   137: goto -11 -> 126
    ...
    //   123	8	0	localException1	Exception
    //   136	1	0	localException2	Exception
    //   63	72	1	localObject2	Object
    ...
    // Exception table:
    //   from	to	target	type
    //   0	60	123	java/lang/Exception
    //   64	69	136	java/lang/Exception
    //   73	80	136	java/lang/Exception
    //   82	97	136	java/lang/Exception
    //   100	121	136	java/lang/Exception
  }
  ...
  public static boolean isPermissionGranted(String paramString)
  {
    ...
    {
      Log.internal("[InMobi]-[AdTracker]-4.4.1", "Cant check permissions", paramString);
    }
    return false;
  }
  ...
  public static void reportMetric(AdTrackerEventType paramAdTrackerEventType, Goal paramGoal, int paramInt1, long paramLong, int paramInt2, String paramString)
  {
    ...
    {
      Log.internal("[InMobi]-[AdTracker]-4.4.1", "Error reporting metric", paramAdTrackerEventType);
      return;
    }
    paramAdTrackerEventType = new JSONObject();
    paramAdTrackerEventType.put("g", paramGoal.getGoalName());
  ...
  public static boolean sendBroadcastMessage(int paramInt)
  {
    ...
    {
      Log.internal("[InMobi]-[AdTracker]-4.4.1", "Cant send test broadcast", localException);
    }
    return false;
  }
  ...
  public static void setInternalReferrer(Context paramContext, String paramString)
  {
    ...
    {
      Log.internal("[InMobi]-[AdTracker]-4.4.1", "Cannot set referrer", paramContext);
      return;
    }
    ...
    Log.internal("[InMobi]-[AdTracker]-4.4.1", "Saving referrer from broadcast receiver: " + paramString);
  ...
  public static void setReferrerFromLogs(Context paramContext, String paramString)
  {
    ...
    {
      Log.internal("[InMobi]-[AdTracker]-4.4.1", "Cannot set referrer from logs", paramContext);
    }
    if (0L == FileOperations.getLongPreferences(paramContext.getApplicationContext(), "IMAdTrackerStatusUpload", "t2")) {
      FileOperations.setPreferences(paramContext.getApplicationContext(), "IMAdTrackerStatusUpload", "t2", System.currentTimeMillis());
    }
...
/* Location:
 * Qualified Name:     com.inmobi.commons.analytics.iat.impl.AdTrackerUtils
