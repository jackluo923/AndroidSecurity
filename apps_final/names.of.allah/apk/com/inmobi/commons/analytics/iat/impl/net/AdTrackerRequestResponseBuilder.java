...
public class AdTrackerRequestResponseBuilder
{
  ...
  protected static String formHTTPRequest(String paramString1, String paramString2, int paramInt, boolean paramBoolean, String paramString3)
  {
    ...
    String str1 = FileOperations.getPreferences(InternalSDKUtil.getContext(), "IMAdTrackerStatusUpload", "referrer");
    ...
    String str2 = AdTrackerInitializer.getConfigParams().getUID().getUidMap(1, paramString1, null);
    if (InternalSDKUtil.isLimitAdTrackingEnabled()) {
      localLinkedList.add(new BasicNameValuePair("u-id-adt", "1"));
    }
    for (;;)
    {
      localLinkedList.add(new BasicNameValuePair("u-id-map", str2));
      ...
      try
      {
        paramString1 = getContextgetPackageManagergetPackageInfogetContextgetPackageName0versionName;
        if ((paramString1 != null) && (!paramString1.trim().equals(""))) {
      ...
      catch (PackageManager.NameNotFoundException paramString1)
      {
        for (;;)
        {
          Log.internal("[InMobi]-[AdTracker]-4.4.1", "Cant get appversion", paramString1);
          paramString1 = null;
        }
      }
    }
  ...
  public static AdTrackerConstants.StatusCode sendHTTPRequest(String paramString1, Goal paramGoal, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        Log.debug("[InMobi]-[AdTracker]-4.4.1", paramString2);
        ...
        if (paramString2.getStatusLine().getStatusCode() == 200)
        {
          ...
          Log.internal("[InMobi]-[AdTracker]-4.4.1", "RESPONSE: " + paramString2);
      ...
      try
      {
        Log.debug("[InMobi]-[AdTracker]-4.4.1", "Error uploading ping " + (String)localObject2 + "\nReloading webview");
    ...
    Log.internal("[InMobi]-[AdTracker]-4.4.1", "Error uploading Goal Ping", paramString1);
    return (AdTrackerConstants.StatusCode)localObject1;
  }
...
/* Location:
 * Qualified Name:     com.inmobi.commons.analytics.iat.impl.net.AdTrackerRequestResponseBuilder
