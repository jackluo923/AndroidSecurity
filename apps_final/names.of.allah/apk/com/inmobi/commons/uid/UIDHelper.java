...
public class UIDHelper
{
  ...
  static String a(String paramString1, String paramString2)
  {
    ...
    {
      Log.debug("[InMobi]-4.4.1", "Exception in xor with random integer", paramString1);
    }
    return "";
  }
  ...
  private static byte[] a(byte[] paramArrayOfByte, int paramInt, Cipher paramCipher)
  {
    ...
    if (paramInt < j)
    {
      ...
      if (paramInt > 0)
      {
        ...
        if (paramInt % 64 == 0)
        {
          localObject4 = a((byte[])localObject3, paramCipher.doFinal((byte[])localObject1));
          if (paramInt + 64 <= j) {
            break label115;
          }
        }
    ...
    for (int i = j - paramInt;; i = 64)
    {
      ...
      localObject2[(paramInt % 64)] = paramArrayOfByte[paramInt];
      paramInt += 1;
      localObject3 = localObject4;
      localObject1 = localObject2;
      break;
      return a((byte[])localObject3, paramCipher.doFinal((byte[])localObject1));
    }
  }
  ...
  private static String b(String paramString1, String paramString2)
  {
    if (paramString1 != null) {
      ...
      {
        Log.debug("[InMobi]-4.4.1", "Exception in getting ODIN-1", paramString1);
        return null;
      }
    }
  ...
  public static String encryptRSA(String paramString)
  {
    ...
    {
      Log.debug("[InMobi]-4.4.1", "Exception in encryptRSA", paramString);
    }
    return null;
  }
  ...
  public static String getFBId(Context paramContext)
  {
    ...
    {
      Log.internal("[InMobi]-4.4.1", "Unable to retrieve Facebook attrib id: " + paramContext);
      return null;
    }
    paramContext = null;
    return paramContext;
  ...
  {
    AdvertisingId localAdvertisingId = new AdvertisingId();
    c = localAdvertisingId;
    localAdvertisingId.a(FileOperations.getPreferences(InternalSDKUtil.getContext(), "impref", "gpid"));
    c.a(FileOperations.getBooleanPreferences(InternalSDKUtil.getContext(), "impref", "limitadtrck"));
    new Thread(new UIDHelper.a()).start();
  }
