...
public class AppInfo
{
  ...
  public static void fillAppInfo()
  {
    try
    {
      ...
      {
        a = packageName;
        b = ((ApplicationInfo)localObject3).loadLabel((PackageManager)localObject2).toString();
      }
    ...
    {
      Log.internal("[InMobi]-4.4.1", "Failed to fill AppInfo", localException);
    }
  }
...
/* Location:
 * Qualified Name:     com.inmobi.commons.data.AppInfo
