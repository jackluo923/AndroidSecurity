...
public class LocationInfo
{
  ...
  static void a(Location paramLocation)
  {
    ...
    {
      f = true;
      c = paramLocation.getLatitude();
      d = paramLocation.getLongitude();
      e = paramLocation.getAccuracy();
      g = paramLocation.getTime();
    }
  }
  ...
  public static void updateBestKnownLocation()
  {
    try
    {
      ...
      if (a() != null)
      {
        ...
        for (;;)
        {
          ...
          Log.debug("[InMobi]-4.4.1", "lastBestKnownLocation: " + localObject2);
          localObject1 = localObject2;
          if (localObject2 == null)
          {
            localObject1 = b();
            Log.debug("[InMobi]-4.4.1", "lastKnownLocation: " + localObject1);
          }
    ...
    {
      Log.debug("[InMobi]-4.4.1", "Error getting the Location Info ", localException);
    }
  }
...
/* Location:
 * Qualified Name:     com.inmobi.commons.data.LocationInfo
