...
public class DeviceInfo
{
  ...
  public void fillDeviceInfo()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        j = WrapperFunctions.getCurrentOrientationInFixedValues(InternalSDKUtil.getContext());
        if (j == 9)
        {
          a(2);
          return;
      ...
      {
        Log.debug("[InMobi]-4.4.1", "Error getting the orientation info ", localException);
        return;
      }
      if (j == 0)
      {
...
/* Location:
 * Qualified Name:     com.inmobi.commons.data.DeviceInfo
