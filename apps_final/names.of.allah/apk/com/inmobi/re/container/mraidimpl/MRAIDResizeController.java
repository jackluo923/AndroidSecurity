...
public class MRAIDResizeController
{
  ...
  private FrameLayout a(JSController.ResizeProperties paramResizeProperties)
  {
    ...
    FrameLayout.LayoutParams localLayoutParams2 = new FrameLayout.LayoutParams(width, height);
    ...
    a(localRelativeLayout, customClosePosition);
    localFrameLayout2.addView(localRelativeLayout, localLayoutParams2);
    a(localFrameLayout1, localFrameLayout2, a, paramResizeProperties);
  ...
  private void a(ViewGroup paramViewGroup, String paramString)
  {
    ...
    CustomView localCustomView = new CustomView(a.getContext(), a.getDensity(), CustomView.SwitchIconType.CLOSE_TRANSPARENT);
    paramViewGroup.addView(localCustomView, paramString);
    localCustomView.setOnClickListener(new MRAIDResizeController.a(this));
  }
  ...
  private void a(FrameLayout paramFrameLayout1, FrameLayout paramFrameLayout2, IMWebView paramIMWebView, JSController.ResizeProperties paramResizeProperties)
  {
    ...
    paramFrameLayout2[0] += offsetX;
    paramFrameLayout2[1] += offsetY;
    if (!allowOffscreen)
    {
      if (width > paramFrameLayout1.getWidth() - paramFrameLayout2[0]) {
        paramFrameLayout2[0] = (paramFrameLayout1.getWidth() - width);
      }
      if (height > paramFrameLayout1.getHeight() - paramFrameLayout2[1]) {
        paramFrameLayout2[1] = (paramFrameLayout1.getHeight() - height);
      }
    ...
    b = new ResizeDimensions(paramFrameLayout2[0], paramFrameLayout2[1], width, height);
    paramFrameLayout1 = new FrameLayout.LayoutParams(width, height);
    leftMargin = paramFrameLayout2[0];
    topMargin = paramFrameLayout2[1];
    gravity = 3;
  ...
  private void b()
  {
    ...
    ((ViewGroup)a.getParent()).removeView(a);
    View localView = ((View)a.getOriginalParent()).findViewById(437);
  ...
  public void doResize(android.os.Bundle arg1)
  {
    ...
    //   191: new 317	com/inmobi/re/container/mraidimpl/MRAIDResizeController$b
    //   194: dup
    //   195: aload_0
    //   196: invokespecial 318	com/inmobi/re/container/mraidimpl/MRAIDResizeController$b:<init>	(Lcom/inmobi/re/container/mraidimpl/MRAIDResizeController;)V
    ...
    //   309: new 338	com/inmobi/re/container/mraidimpl/MRAIDResizeController$c
    //   312: dup
    //   313: aload_0
    ...
    //   333	337	337	java/lang/Exception
    //   367	390	393	finally
  }
  
  public void onOrientationChange()
  {
    if ((a.getStateVariable() == IMWebView.ViewState.RESIZED) && (!resizeProperties.allowOffscreen)) {
      doResize(null);
    }
  }
  ...
  public void reset()
  {
    resizeProperties = new JSController.ResizeProperties();
  }
}
