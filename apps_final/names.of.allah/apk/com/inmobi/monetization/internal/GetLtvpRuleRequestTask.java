  ...
  implements Runnable
{
  ...
  {
    a = paramGetLtvpRulesRequest;
    b = paramIGetLtvpRuleRequestListener;
  }
  ...
  public void run()
  {
    try
    {
      ...
      localObject2 = localObject2 + "?" + a.getEncodedRequestParams();
      ...
      if (((HttpResponse)localObject1).getStatusLine().getStatusCode() == 200)
      {
        ...
        if (!((JSONObject)localObject1).getBoolean("success"))
        {
          ...
          if (b != null) {
            b.onLtvpGetRuleFailed(a, new LtvpErrorCode(i, (String)localObject1));
          }
        }
        else
        {
    ...
    catch (Exception localException)
    {
      ...
      if (b != null)
      {
        ...
        if (b != null) {
          b.onLtvpGetRuleSucceeded(a, localException);
        }
      }
    }
  }
...
/* Location:
 * Qualified Name:     com.inmobi.monetization.internal.GetLtvpRuleRequestTask
