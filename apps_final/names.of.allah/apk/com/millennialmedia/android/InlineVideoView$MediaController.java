  ...
  extends MediaController
{
  ...
  public InlineVideoView$MediaController(InlineVideoView paramInlineVideoView, Context paramContext)
  {
    super(paramContext);
  }
  ...
  public void setAnchorView(View paramView)
  {
    ...
    catch (Exception localException1)
    {
      try
      {
        ...
        if (this$0.inlineParams.goingFullScreen)
        {
          paramView.setBackgroundDrawable(inDrawable);
          paramView.setOnClickListener(new InlineVideoView.MediaController.1(this));
      ...
      catch (Exception localException2)
      {
        for (;;)
        {
          ...
          continue;
          paramView.setBackgroundDrawable(outDrawable);
        }
      }
    }
  }
...
/* Location:
 * Qualified Name:     com.millennialmedia.android.InlineVideoView.MediaController
