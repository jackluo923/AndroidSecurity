  ...
  extends TypeAdapter<JsonElement>
{
  ...
  {
    switch (TypeAdapters.32.$SwitchMap$com$millennialmedia$google$gson$stream$JsonToken[paramJsonReader.peek().ordinal()])
    {
    default: 
...
/* Location:
 * Qualified Name:     com.millennialmedia.google.gson.internal.bind.TypeAdapters.25
