  ...
  implements ViewGestureDetector.UserClickListener
{
  ...
  {
    this(paramContext, MraidView.ExpansionStyle.ENABLED, MraidView.NativeCloseButtonStyle.AD_CONTROLLED, MraidView.PlacementType.INLINE);
  }
  
  public MraidView(Context paramContext, MraidView.ExpansionStyle paramExpansionStyle, MraidView.NativeCloseButtonStyle paramNativeCloseButtonStyle, MraidView.PlacementType paramPlacementType)
  {
    super(paramContext);
    mPlacementType = paramPlacementType;
    mViewGestureDetector = new ViewGestureDetector(paramContext, this);
  ...
  private void initialize(MraidView.ExpansionStyle paramExpansionStyle, MraidView.NativeCloseButtonStyle paramNativeCloseButtonStyle)
  {
    ...
    mDisplayController = new MraidDisplayController(this, paramExpansionStyle, paramNativeCloseButtonStyle);
    mWebViewClient = new MraidView.MraidWebViewClient(this, null);
    setWebViewClient(mWebViewClient);
    mListenerInfo = new MraidView.MraidListenerInfo();
  }
  
  private void notifyOnFailureListener()
  {
    if (MraidView.MraidListenerInfo.access$0(mListenerInfo) != null) {
      MraidView.MraidListenerInfo.access$0(mListenerInfo).onFailure(this);
    }
  }
  ...
  private boolean tryCommand(URI paramURI)
  {
    ...
    if ((paramURI.isCommandDependentOnUserClick(mPlacementType)) && (!wasClicked())) {
      return false;
    }
    paramURI.execute();
    fireNativeCommandCompleteEvent(str);
  ...
  {
    return MraidView.MraidListenerInfo.access$0(mListenerInfo);
  }
  ...
  {
    return MraidView.MraidListenerInfo.access$3(mListenerInfo);
  }
  
  public MraidView.OnOpenListener getOnOpenListener()
  {
    return MraidView.MraidListenerInfo.access$5(mListenerInfo);
  }
  ...
  public void loadUrl(String paramString)
  {
    ...
    try
    {
      ...
      localObject = ((HttpClient)localObject).execute(localHttpGet).getEntity();
      if (localObject != null) {
  ...
  {
    mDisplayController = paramMraidDisplayController;
  }
  
  public void setMraidListener(MraidView.MraidListener paramMraidListener)
  {
    MraidView.MraidListenerInfo.access$1(mListenerInfo, paramMraidListener);
  }
  
  public void setOnCloseButtonStateChange(MraidView.OnCloseButtonStateChangeListener paramOnCloseButtonStateChangeListener)
  {
    MraidView.MraidListenerInfo.access$2(mListenerInfo, paramOnCloseButtonStateChangeListener);
  }
  
  public void setOnOpenListener(MraidView.OnOpenListener paramOnOpenListener)
  {
    MraidView.MraidListenerInfo.access$4(mListenerInfo, paramOnOpenListener);
  }
...
/* Location:
 * Qualified Name:     com.adsdk.sdk.mraid.MraidView
