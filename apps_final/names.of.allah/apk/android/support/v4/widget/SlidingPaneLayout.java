  ...
  extends ViewGroup
{
  ...
  private void a(View paramView, float paramFloat, int paramInt)
  {
    ...
    paramView = new r(this, paramView);
    u.add(paramView);
    af.a(this, paramView);
  }
  ...
  private boolean a(float paramFloat)
  {
    ...
    boolean bool = b();
    Object localObject = (s)h.getLayoutParams();
    int i1;
    int i2;
    if (bool)
    {
  ...
  private boolean b(View paramView)
  {
    ...
    paramView = (s)paramView.getLayoutParams();
    return (g) && (c) && (i > 0.0F);
  }
  ...
  public final boolean onInterceptTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    if ((!g) && (i1 == 0) && (getChildCount() > 1))
    {
      ...
      {
        z localz = q;
        if (z.b((View)localObject, (int)paramMotionEvent.getX(), (int)paramMotionEvent.getY())) {
          break label110;
        }
      }
    }
  ...
  protected final void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (bool)
    {
      ...
      localObject2 = (s)((View)localObject1).getLayoutParams();
        ...
        if (s)
        {
          if (g)
          {
            if (m != 0)
            {
              float f2 = i;
              paramBoolean = b();
              localObject1 = (s)h.getLayoutParams();
              if (c) {
                if (paramBoolean)
                {
  ...
  public final void setPanelSlideListener(t paramt)
  {
    p = paramt;
  }
  ...
  {
    d = getResources().getDrawable(paramInt);
  }
  ...
  {
    e = getResources().getDrawable(paramInt);
  }
