  ...
  extends Activity
{
  ...
  public View onCreateView(String paramString, Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    if (paramContext == null)
    {
      ...
      if (j != 0)
      {
        ...
        mFragments.addFragment(paramString, true);
      }
    }
    for (;;)
    {
  ...
  public final Object onRetainNonConfigurationInstance()
  {
    ...
    if (mAllLoaderManagers != null)
    {
      ...
      while (i >= 0)
      {
        localObject2[i] = ((LoaderManagerImpl)mAllLoaderManagers.b(i));
        i -= 1;
      }
      i = 0;
      k = i;
  ...
  protected void onStart()
  {
    ...
    for (;;)
    {
      ...
      while (i >= 0)
      {
        arrayOfLoaderManagerImpl[i] = ((LoaderManagerImpl)mAllLoaderManagers.b(i));
        i -= 1;
      }
      label146:
