.class Lcom/alipay/android/phone/nfd/nfdservice/api/INfdServiceFacade$Stub$Proxy;
...
.method constructor <init>(Landroid/os/IBinder;)V
    ...
    iput-object p1, p0, Lcom/alipay/android/phone/nfd/nfdservice/api/INfdServiceFacade$Stub$Proxy;->a:Landroid/os/IBinder;
...
.method public asBinder()Landroid/os/IBinder;
    ...
    iget-object v0, p0, Lcom/alipay/android/phone/nfd/nfdservice/api/INfdServiceFacade$Stub$Proxy;->a:Landroid/os/IBinder;
...
.method public connectTargetAP(Lcom/alipay/android/phone/nfd/nfdservice/api/model/NfdWifiRequest;)I
    ...
    invoke-virtual {p1, v1, v0}, Lcom/alipay/android/phone/nfd/nfdservice/api/model/NfdWifiRequest;->writeToParcel(Landroid/os/Parcel;I)V
...
.method public forgetNetwork(Ljava/lang/String;)Z
    ...
    :try_start_0
    const-string/jumbo v3, "com.alipay.android.phone.nfd.nfdservice.api.INfdServiceFacade"

    invoke-virtual {v1, v3}, Landroid/os/Parcel;->writeInterfaceToken(Ljava/lang/String;)V

    invoke-virtual {v1, p1}, Landroid/os/Parcel;->writeString(Ljava/lang/String;)V

    iget-object v3, p0, Lcom/alipay/android/phone/nfd/nfdservice/api/INfdServiceFacade$Stub$Proxy;->a:Landroid/os/IBinder;
...
.method public getLightBizNfdService()Lcom/alipay/android/phone/nfd/nfdservice/api/ILightBizNfdService;
    ...
    invoke-static {v0}, Lcom/alipay/android/phone/nfd/nfdservice/api/ILightBizNfdService$Stub;->asInterface(Landroid/os/IBinder;)Lcom/alipay/android/phone/nfd/nfdservice/api/ILightBizNfdService;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public getNearbyWifiServiceList(ZLcom/alipay/android/phone/nfd/nfdservice/api/INfdQueryWifiDataCallback;)Ljava/util/List;
    ...
    invoke-interface {p2}, Lcom/alipay/android/phone/nfd/nfdservice/api/INfdQueryWifiDataCallback;->asBinder()Landroid/os/IBinder;
    ...
    sget-object v0, Lcom/alipay/android/phone/nfd/nfdservice/api/NearbyWifiServiceInfo;->CREATOR:Landroid/os/Parcelable$Creator;
...
.method public queryWifiDataSync(Z)Lcom/alipay/android/phone/nfd/nfdservice/api/model/NfdQueryWifiDataResult;
    ...
    sget-object v0, Lcom/alipay/android/phone/nfd/nfdservice/api/model/NfdQueryWifiDataResult;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-interface {v0, v2}, Landroid/os/Parcelable$Creator;->createFromParcel(Landroid/os/Parcel;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lcom/alipay/android/phone/nfd/nfdservice/api/model/NfdQueryWifiDataResult;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public recordInStore(Lcom/alipay/android/phone/nfd/nfdservice/api/model/NfdWifiDetailInfo;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p1, v1, v0}, Lcom/alipay/android/phone/nfd/nfdservice/api/model/NfdWifiDetailInfo;->writeToParcel(Landroid/os/Parcel;I)V
...
.method public registerNfdEventListener(Lcom/alipay/android/phone/nfd/nfdservice/api/INfdEventListener;)Z
    ...
    :try_start_0
    const-string/jumbo v1, "com.alipay.android.phone.nfd.nfdservice.api.INfdServiceFacade"

    invoke-virtual {v2, v1}, Landroid/os/Parcel;->writeInterfaceToken(Ljava/lang/String;)V

    if-eqz p1, :cond_1

    invoke-interface {p1}, Lcom/alipay/android/phone/nfd/nfdservice/api/INfdEventListener;->asBinder()Landroid/os/IBinder;
    ...
    iget-object v1, p0, Lcom/alipay/android/phone/nfd/nfdservice/api/INfdServiceFacade$Stub$Proxy;->a:Landroid/os/IBinder;
