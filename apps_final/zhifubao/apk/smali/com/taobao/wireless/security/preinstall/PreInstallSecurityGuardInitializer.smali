...
.method public static Initialize(Landroid/content/Context;)I
    ...
    instance-of v2, v0, Lcom/alibaba/wireless/security/open/initialize/b;

    if-eqz v2, :cond_0

    check-cast v0, Lcom/alibaba/wireless/security/open/initialize/b;

    const/4 v2, 0x0

    const/4 v3, 0x0

    invoke-virtual {v0, p0, v2, v3}, Lcom/alibaba/wireless/security/open/initialize/b;->a(Landroid/content/Context;Ljava/lang/String;Z)I
    :try_end_0
...
.method public static Initialize(Landroid/content/Context;Ljava/lang/String;)I
    ...
    invoke-virtual {v0, p0, p1, v2}, Lcom/alibaba/wireless/security/open/initialize/b;->a(Landroid/content/Context;Ljava/lang/String;Z)I
    :try_end_0
    .catch Lcom/alibaba/wireless/security/open/SecException; {:try_start_0 .. :try_end_0} :catch_0
