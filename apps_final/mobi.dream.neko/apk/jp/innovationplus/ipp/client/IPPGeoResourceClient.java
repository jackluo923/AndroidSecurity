...
public final class IPPGeoResourceClient
  extends _HttpURLConnection
{
  ...
  public IPPGeoResourceClient(Context paramContext)
  {
    super(paramContext, "/georesource");
  }
  
  public <T extends IPPGeoResource<? extends IPPApplicationResource>> void create(Class<T> paramClass, T paramT, IPPQueryCallback<String> paramIPPQueryCallback)
    throws IPPException
  {
    try
    {
      super.setResourcePath("/georesource" + "/" + ((IPPGeoResource)paramClass.newInstance()).getResourceName());
      super.ippPostRequest(String.class, paramT, paramIPPQueryCallback);
      return;
    }
    catch (Exception paramClass)
    {
      while (!isDebugMessage()) {}
      Log.d("IPPKit", "can not instanciate resource class", paramClass);
    }
  }
  
  public <T extends IPPGeoResource<? extends IPPApplicationResource>> void createAll(Class<T> paramClass, T[] paramArrayOfT, IPPQueryCallback<Void> paramIPPQueryCallback)
    throws IPPException
  {
    try
    {
      super.setResourcePath("/georesources" + "/" + ((IPPGeoResource)paramClass.newInstance()).getResourceName());
      super.ippPostRequest(Void.class, paramArrayOfT, paramIPPQueryCallback);
      return;
    }
    catch (Exception paramClass)
    {
  ...
  public <T extends IPPGeoResource<? extends IPPApplicationResource>> void delete(Class<T> paramClass, String paramString, IPPQueryCallback<String> paramIPPQueryCallback)
    throws IPPException
  {
    try
    {
      super.setResourcePath("/georesource" + "/" + ((IPPGeoResource)paramClass.newInstance()).getResourceName() + "/" + paramString);
  ...
  public <T extends IPPGeoResource<? extends IPPApplicationResource>> void get(Class<T> paramClass, String paramString, IPPQueryCallback<T> paramIPPQueryCallback)
    throws IPPException
  {
    try
    {
      Log.d("IPPKit", "rettype:" + ((IPPGeoResource)paramClass.newInstance()).getResourceName());
      super.setResourcePath("/georesource" + "/" + ((IPPGeoResource)paramClass.newInstance()).getResourceName() + "/" + paramString);
      super.ippGetRequest(paramClass, paramIPPQueryCallback);
      return;
    }
    catch (Exception paramClass)
    {
  ...
  public <T extends IPPGeoResource<? extends IPPApplicationResource>> void query(Class<T> paramClass, QueryCondition paramQueryCondition, IPPQueryCallback<T[]> paramIPPQueryCallback)
    throws IPPException
  {
    try
    {
      super.setResourcePath("/georesources" + "/" + ((IPPGeoResource)paramClass.newInstance()).getResourceName());
      super.ippGetRequest(((IPPGeoResource[])Array.newInstance(paramClass, 0)).getClass(), paramQueryCondition.build(), paramIPPQueryCallback);
      return;
    }
    catch (Exception paramClass)
    {
...
/* Location:
 * Qualified Name:     jp.innovationplus.ipp.client.IPPGeoResourceClient
