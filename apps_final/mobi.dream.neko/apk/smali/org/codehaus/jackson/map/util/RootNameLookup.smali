...
.method public declared-synchronized findRootName(Ljava/lang/Class;Lorg/codehaus/jackson/map/MapperConfig;)Lorg/codehaus/jackson/io/SerializedString;
    ...
    invoke-direct {v3, p1}, Lorg/codehaus/jackson/map/type/ClassKey;-><init>(Ljava/lang/Class;)V

    .line 33
    .local v3, "key":Lorg/codehaus/jackson/map/type/ClassKey;
    iget-object v6, p0, Lorg/codehaus/jackson/map/util/RootNameLookup;->_rootNames:Lorg/codehaus/jackson/map/util/LRUMap;

    if-nez v6, :cond_2

    .line 34
    new-instance v6, Lorg/codehaus/jackson/map/util/LRUMap;

    const/16 v7, 0x14

    const/16 v8, 0xc8

    invoke-direct {v6, v7, v8}, Lorg/codehaus/jackson/map/util/LRUMap;-><init>(II)V

    iput-object v6, p0, Lorg/codehaus/jackson/map/util/RootNameLookup;->_rootNames:Lorg/codehaus/jackson/map/util/LRUMap;
    ...
    .line 43
    .local v2, "intr":Lorg/codehaus/jackson/map/AnnotationIntrospector;
    ...
    invoke-virtual {v2, v0}, Lorg/codehaus/jackson/map/AnnotationIntrospector;->findRootName(Lorg/codehaus/jackson/map/introspect/AnnotatedClass;)Ljava/lang/String;
    ...
    .line 50
    :cond_1
    new-instance v4, Lorg/codehaus/jackson/io/SerializedString;

    invoke-direct {v4, v5}, Lorg/codehaus/jackson/io/SerializedString;-><init>(Ljava/lang/String;)V

    .line 51
    .local v4, "name":Lorg/codehaus/jackson/io/SerializedString;
    iget-object v6, p0, Lorg/codehaus/jackson/map/util/RootNameLookup;->_rootNames:Lorg/codehaus/jackson/map/util/LRUMap;

    invoke-virtual {v6, v3, v4}, Lorg/codehaus/jackson/map/util/LRUMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .line 52
    .end local v0    # "ac":Lorg/codehaus/jackson/map/introspect/AnnotatedClass;
    .end local v1    # "beanDesc":Lorg/codehaus/jackson/map/introspect/BasicBeanDescription;
    .end local v2    # "intr":Lorg/codehaus/jackson/map/AnnotationIntrospector;
    ...
    .line 36
    .end local v4    # "name":Lorg/codehaus/jackson/io/SerializedString;
    :cond_2
    :try_start_1
    iget-object v6, p0, Lorg/codehaus/jackson/map/util/RootNameLookup;->_rootNames:Lorg/codehaus/jackson/map/util/LRUMap;

    invoke-virtual {v6, v3}, Lorg/codehaus/jackson/map/util/LRUMap;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 37
    .restart local v4    # "name":Lorg/codehaus/jackson/io/SerializedString;
    if-eqz v4, :cond_0

    goto :goto_0

    .line 31
    .end local v3    # "key":Lorg/codehaus/jackson/map/type/ClassKey;
    .end local v4    # "name":Lorg/codehaus/jackson/io/SerializedString;
    :catchall_0
    move-exception v6
