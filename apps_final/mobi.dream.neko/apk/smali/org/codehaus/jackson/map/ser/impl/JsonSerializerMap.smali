...
.method public constructor <init>(Ljava/util/Map;)V
    ...
    .prologue
    .line 20
    .local p1, "serializers":Ljava/util/Map;, "Ljava/util/Map<Lorg/codehaus/jackson/map/ser/impl/SerializerCache$TypeKey;Lorg/codehaus/jackson/map/JsonSerializer<Ljava/lang/Object;>;>;"
    ...
    .line 26
    .local v1, "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Lorg/codehaus/jackson/map/ser/impl/SerializerCache$TypeKey;Lorg/codehaus/jackson/map/JsonSerializer<Ljava/lang/Object;>;>;"
    invoke-interface {v1}, Ljava/util/Map$Entry;->getKey()Ljava/lang/Object;

    move-result-object v5

    check-cast v5, Lorg/codehaus/jackson/map/ser/impl/SerializerCache$TypeKey;

    .line 27
    .local v5, "key":Lorg/codehaus/jackson/map/ser/impl/SerializerCache$TypeKey;
    invoke-virtual {v5}, Lorg/codehaus/jackson/map/ser/impl/SerializerCache$TypeKey;->hashCode()I
    ...
    invoke-direct {v8, v9, v5, v7}, Lorg/codehaus/jackson/map/ser/impl/JsonSerializerMap$Bucket;-><init>(Lorg/codehaus/jackson/map/ser/impl/JsonSerializerMap$Bucket;Lorg/codehaus/jackson/map/ser/impl/SerializerCache$TypeKey;Lorg/codehaus/jackson/map/JsonSerializer;)V
    ...
    .line 30
    .end local v1    # "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Lorg/codehaus/jackson/map/ser/impl/SerializerCache$TypeKey;Lorg/codehaus/jackson/map/JsonSerializer<Ljava/lang/Object;>;>;"
    .end local v4    # "index":I
    .end local v5    # "key":Lorg/codehaus/jackson/map/ser/impl/SerializerCache$TypeKey;
    :cond_0
...
.method public find(Lorg/codehaus/jackson/map/ser/impl/SerializerCache$TypeKey;)Lorg/codehaus/jackson/map/JsonSerializer;
    .locals 5
    .param p1, "key"    # Lorg/codehaus/jackson/map/ser/impl/SerializerCache$TypeKey;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lorg/codehaus/jackson/map/ser/impl/SerializerCache$TypeKey;",
    ...
    .line 63
    :cond_1
    iget-object v3, v0, Lorg/codehaus/jackson/map/ser/impl/JsonSerializerMap$Bucket;->key:Lorg/codehaus/jackson/map/ser/impl/SerializerCache$TypeKey;

    invoke-virtual {p1, v3}, Lorg/codehaus/jackson/map/ser/impl/SerializerCache$TypeKey;->equals(Ljava/lang/Object;)Z
