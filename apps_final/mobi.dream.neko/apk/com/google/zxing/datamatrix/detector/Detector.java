...
public final class Detector
{
    ...
    throws NotFoundException
  {
    ...
    rectangleDetector = new WhiteRectangleDetector(paramBitMatrix);
  }
  ...
  {
    return (paramResultPoint.getX() >= 0.0F) && (paramResultPoint.getX() < image.getWidth()) && (paramResultPoint.getY() > 0.0F) && (paramResultPoint.getY() < image.getHeight());
  }
  ...
  public DetectorResult detect()
    throws NotFoundException
  {
    Object localObject1 = rectangleDetector.detect();
    ...
    for (localObject1 = sampleGrid(image, localEntry, localIterator, (ResultPoint)localObject4, (ResultPoint)localObject2, i, j);; localObject1 = sampleGrid(image, localEntry, localIterator, (ResultPoint)localObject4, (ResultPoint)localObject2, i, i))
    {
