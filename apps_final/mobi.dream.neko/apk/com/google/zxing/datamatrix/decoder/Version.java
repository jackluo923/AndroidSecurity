...
public final class Version
{
  ...
  {
    versionNumber = paramInt1;
    symbolSizeRows = paramInt2;
    symbolSizeColumns = paramInt3;
    dataRegionSizeRows = paramInt4;
    dataRegionSizeColumns = paramInt5;
    ecBlocks = paramECBlocks;
    paramInt2 = 0;
    ...
    throws FormatException
  {
    ...
    while (i < j)
    {
      ...
      if ((symbolSizeRows == paramInt1) && (symbolSizeColumns == paramInt2)) {
        return localVersion;
      }
      i += 1;
    }
