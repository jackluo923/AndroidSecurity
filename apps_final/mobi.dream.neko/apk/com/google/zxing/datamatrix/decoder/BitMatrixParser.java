...
final class BitMatrixParser
{
    ...
    throws FormatException
  {
    ...
    version = readVersion(paramBitMatrix);
    mappingBitMatrix = extractDataRegion(paramBitMatrix);
  ...
  {
    int j = version.getSymbolSizeRows();
    int i = version.getSymbolSizeColumns();
    if (paramBitMatrix.getHeight() != j) {
      throw new IllegalArgumentException("Dimension of bitMarix must match the version size");
    }
    int n = version.getDataRegionSizeRows();
    int i1 = version.getDataRegionSizeColumns();
    int i2 = j / n;
    int i3 = i / i1;
    ...
    throws FormatException
  {
    ...
    int j = 4;
    int i = 0;
    int i6 = mappingBitMatrix.getHeight();
    int i7 = mappingBitMatrix.getWidth();
    int i3 = 0;
    int i2 = 0;
    int i1 = 0;
    int n = 0;
    ...
    for (;;)
    {
      if ((j >= i6) && (i >= i7)) {
        if (k != version.getTotalCodewords())
        {
          ...
          if ((i4 >= i6) || (i5 < 0) || (readMappingMatrix.get(i5, i4))) {
            break label537;
          }
          i = m + 1;
    ...
    for (;;)
    {
      ...
      j = i5 + 3;
      label437:
      if ((m >= 0) && (j < i7) && (!readMappingMatrix.get(j, m)))
      {
        k = i + 1;
  ...
  boolean readModule(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    readMappingMatrix.set(paramInt1, paramInt2);
    return mappingBitMatrix.get(paramInt1, paramInt2);
  }
