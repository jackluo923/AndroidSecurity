  ...
  implements Reader
{
    ...
    throws NotFoundException
  {
    if (readers != null)
    {
      ...
      while (i < j)
      {
        ...
        try
        {
          localObject = ((Reader)localObject).decode(paramBinaryBitmap, hints);
  ...
  public void setHints(Map<DecodeHintType, ?> paramMap)
  {
    ...
    for (Collection localCollection = null;; localCollection = (Collection)paramMap.get(DecodeHintType.POSSIBLE_FORMATS))
    {
      ...
      readers = ((Reader[])localArrayList.toArray(new Reader[localArrayList.size()]));
      return;
      i = 0;
      break;
    }
