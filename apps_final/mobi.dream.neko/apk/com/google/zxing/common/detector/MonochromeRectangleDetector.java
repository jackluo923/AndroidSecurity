...
public final class MonochromeRectangleDetector
{
  ...
  private int[] blackWhiteRange(int paramInt1, int paramInt2, int paramInt3, int paramInt4, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      if (paramBoolean)
      {
        if (!image.get(i, paramInt1)) {}
      }
      else {
        while (image.get(paramInt1, i))
        {
          j = i - 1;
          break;
        }
    ...
    if (paramInt3 < paramInt4)
    {
      if (paramBoolean)
      {
        ...
        label174:
        while (image.get(paramInt1, paramInt3))
        {
          i = paramInt3 + 1;
          break label137;
          j = m;
          if (!image.get(paramInt1, m)) {
            break;
          }
          break label104;
        }
