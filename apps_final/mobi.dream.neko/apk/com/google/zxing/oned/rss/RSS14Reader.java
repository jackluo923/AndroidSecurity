  ...
  extends AbstractRSSReader
{
  ...
  static
  {
    ...
    int[] arrayOfInt2 = { 1, 5, 7, 1 };
    FINDER_PATTERNS = new int[][] { { 3, 8, 2, 1 }, { 3, 5, 5, 1 }, arrayOfInt1, { 3, 1, 9, 1 }, { 2, 7, 4, 1 }, { 2, 5, 6, 1 }, { 2, 3, 8, 1 }, arrayOfInt2, { 1, 3, 9, 1 } };
  }
    ...
    throws NotFoundException
  {
    ...
    addOrTally(possibleLeftPairs, (Pair)localObject);
    paramBitArray.reverse();
    paramMap = decodePair(paramBitArray, true, paramInt, paramMap);
    addOrTally(possibleRightPairs, paramMap);
    paramBitArray.reverse();
    Pair localPair;
    do
    {
      paramBitArray = possibleLeftPairs.iterator();
      while (!((Iterator)localObject).hasNext())
      {
        ...
        localObject = possibleRightPairs.iterator();
      }
