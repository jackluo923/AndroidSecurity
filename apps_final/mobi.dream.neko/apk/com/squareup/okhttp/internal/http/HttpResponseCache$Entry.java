...
final class HttpResponseCache$Entry
{
    ...
    throws IOException
  {
    ...
    //   82: dup
    //   83: aload_1
    //   84: invokespecial 185	java/io/IOException:<init>	(Ljava/lang/Throwable;)V
    //   87: athrow
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	88	0	this	Entry
    //   0	88	1	paramStrictLineReader	StrictLineReader
    ...
    throws IOException
  {
    ...
    //   99: dup
    //   100: aload_1
    //   101: invokespecial 185	java/io/IOException:<init>	(Ljava/lang/Throwable;)V
    //   104: athrow
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	105	0	this	Entry
...
/* Location:
 * Qualified Name:     com.squareup.okhttp.internal.http.HttpResponseCache.Entry
