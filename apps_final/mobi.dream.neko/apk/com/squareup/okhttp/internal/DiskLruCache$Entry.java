...
final class DiskLruCache$Entry
{
  ...
  {
    key = paramString;
    lengths = new long[DiskLruCache.access$1800(paramDiskLruCache)];
  }
  ...
  private void setLengths(String[] paramArrayOfString)
    throws IOException
  {
    if (paramArrayOfString.length != DiskLruCache.access$1800(this$0)) {
  ...
  {
    return new File(DiskLruCache.access$1900(this$0), key + "." + paramInt);
  }
  
  public File getDirtyFile(int paramInt)
  {
    return new File(DiskLruCache.access$1900(this$0), key + "." + paramInt + ".tmp");
  }
