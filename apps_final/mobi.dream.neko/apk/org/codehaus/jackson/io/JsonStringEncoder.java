...
public final class JsonStringEncoder
{
  ...
  public char[] quoteAsString(String paramString)
  {
    ...
    if (k < i1)
    {
      ...
      {
        i2 = _appendSingleEscape(arrayOfInt[paramString.charAt(k)], _quoteBuffer);
        ...
        j = i2 - m;
        System.arraycopy(_quoteBuffer, m, localObject1, 0, j);
      }
    }
    for (;;)
    {
      ...
      break label67;
      label248:
      System.arraycopy(_quoteBuffer, 0, localObject1, j, i2);
      j += i2;
    }
  }
