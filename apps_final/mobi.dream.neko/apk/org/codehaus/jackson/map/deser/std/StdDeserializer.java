  ...
  extends JsonDeserializer<T>
{
    ...
    throws IOException, JsonProcessingException
  {
    ...
    if (localJsonToken == JsonToken.VALUE_STRING)
    {
      ...
      {
        throw paramDeserializationContext.weirdStringException(_valueClass, "not a valid Byte value");
      }
    ...
    throws IOException, JsonProcessingException
  {
    ...
    if (localJsonToken == JsonToken.VALUE_STRING)
    {
      ...
      try
      {
        ...
        l = Long.parseLong(paramJsonParser);
        if ((l < -2147483648L) || (l > 2147483647L)) {
          throw paramDeserializationContext.weirdStringException(_valueClass, "Overflow: numeric value (" + paramJsonParser + ") out of range of Integer (" + Integer.MIN_VALUE + " - " + Integer.MAX_VALUE + ")");
        }
      }
      catch (IllegalArgumentException paramJsonParser)
      {
    ...
    throws IOException, JsonProcessingException
  {
    ...
    if (localJsonToken == JsonToken.VALUE_STRING)
    {
      ...
      {
        throw paramDeserializationContext.weirdStringException(_valueClass, "not a valid Short value");
      }
