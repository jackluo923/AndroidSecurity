  ...
  implements ResolvableSerializer
{
  ...
  {
    return new EnumMapSerializer(_valueType, _staticTyping, _keyEnums, paramTypeSerializer, _property, _valueSerializer);
  }
    ...
    throws IOException, JsonGenerationException
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (localObject4 == null) {
        localObject2 = ((EnumSerializer)paramSerializerProvider.findValueSerializer(((Enum)localObject6).getDeclaringClass(), _property)).getEnumValues();
      }
    ...
    for (;;)
    {
      ...
      break;
      label210:
      Object localObject5 = paramSerializerProvider.findValueSerializer((Class)localObject6, _property);
