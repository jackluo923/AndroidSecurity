  ...
  implements ResolvableSerializer
{
  ...
  {
    paramTypeSerializer = new MapSerializer(_ignoredEntries, _keyType, _valueType, _valueTypeIsStatic, paramTypeSerializer, _keySerializer, _valueSerializer, _property);
    ...
    throws JsonMappingException
  {
    if ((_valueTypeIsStatic) && (_valueSerializer == null)) {
      _valueSerializer = paramSerializerProvider.findValueSerializer(_valueType, _property);
    }
    if (_keySerializer == null) {
      _keySerializer = paramSerializerProvider.findKeySerializer(_keyType, _property);
    }
  }
    ...
    throws IOException, JsonGenerationException
  {
    ...
    label290:
    label292:
    for (Object localObject1 = _findAndAddDynamic((PropertySerializerMap)localObject1, paramSerializerProvider.constructSpecializedType(_valueType, localClass), paramSerializerProvider);; localObject2 = _findAndAddDynamic((PropertySerializerMap)localObject2, localClass, paramSerializerProvider))
    {
    ...
    throws IOException, JsonGenerationException
  {
    ...
    for (;;)
    {
      try
      {
        ((JsonSerializer)localObject3).serializeWithType(localObject4, paramJsonGenerator, paramSerializerProvider, _valueTypeSerializer);
      }
      catch (Exception localException)
      {
      ...
      break;
      JsonSerializer localJsonSerializer1 = paramSerializerProvider.findValueSerializer(localClass, _property);
