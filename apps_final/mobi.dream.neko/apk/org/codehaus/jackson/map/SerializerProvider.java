...
public abstract class SerializerProvider
{
  ...
  protected SerializerProvider(SerializationConfig paramSerializationConfig)
  {
    ...
    for (paramSerializationConfig = null;; paramSerializationConfig = _config.getSerializationView())
    {
      _serializationView = paramSerializationConfig;
      return;
    }
  }
  ...
  {
    return _config.constructSpecializedType(paramJavaType, paramClass);
  }
  
  public JavaType constructType(Type paramType)
  {
    return _config.getTypeFactory().constructType(paramType);
  }
  ...
  {
    return _config.isEnabled(paramFeature);
  }
