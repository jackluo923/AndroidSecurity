  ...
  implements Versioned
{
  ...
  protected JsonGenerator _createJsonGenerator(Writer paramWriter, IOContext paramIOContext)
    throws IOException
  {
    paramWriter = new WriterBasedGenerator(paramIOContext, _generatorFeatures, _objectCodec, paramWriter);
    if (_characterEscapes != null) {
      paramWriter.setCharacterEscapes(_characterEscapes);
    }
    return paramWriter;
  }
  ...
  {
    return new ByteSourceBootstrapper(paramIOContext, paramInputStream).constructParser(_parserFeatures, _objectCodec, _rootByteSymbols, _rootCharSymbols);
  }
  
  protected JsonParser _createJsonParser(Reader paramReader, IOContext paramIOContext)
    throws IOException, JsonParseException
  {
    return new ReaderBasedParser(paramIOContext, _parserFeatures, paramReader, _objectCodec, _rootCharSymbols.makeChild(isEnabled(JsonParser.Feature.CANONICALIZE_FIELD_NAMES), isEnabled(JsonParser.Feature.INTERN_FIELD_NAMES)));
  }
  
  protected JsonParser _createJsonParser(byte[] paramArrayOfByte, int paramInt1, int paramInt2, IOContext paramIOContext)
    throws IOException, JsonParseException
  {
    return new ByteSourceBootstrapper(paramIOContext, paramArrayOfByte, paramInt1, paramInt2).constructParser(_parserFeatures, _objectCodec, _rootByteSymbols, _rootCharSymbols);
  }
  
  protected JsonGenerator _createUTF8JsonGenerator(OutputStream paramOutputStream, IOContext paramIOContext)
    throws IOException
  {
    paramOutputStream = new Utf8Generator(paramIOContext, _generatorFeatures, _objectCodec, paramOutputStream);
    if (_characterEscapes != null) {
      paramOutputStream.setCharacterEscapes(_characterEscapes);
    }
    ...
    throws IOException
  {
    ...
    if (paramJsonEncoding == JsonEncoding.UTF8)
    {
      ...
      if (_outputDecorator != null) {
        paramFile = _outputDecorator.decorate(localIOContext, localFileOutputStream);
      }
    ...
    if (_outputDecorator != null) {
      paramFile = _outputDecorator.decorate(localIOContext, paramJsonEncoding);
    }
    ...
    throws IOException
  {
    ...
    if (paramJsonEncoding == JsonEncoding.UTF8)
    {
      ...
      if (_outputDecorator != null) {
        paramJsonEncoding = _outputDecorator.decorate(localIOContext, paramOutputStream);
      }
    ...
    if (_outputDecorator != null) {
      paramOutputStream = _outputDecorator.decorate(localIOContext, paramJsonEncoding);
    }
    ...
    throws IOException
  {
    ...
    if (_outputDecorator != null) {
      localWriter = _outputDecorator.decorate(localIOContext, paramWriter);
    }
    ...
    throws IOException, JsonParseException
  {
    ...
    if (_inputDecorator != null) {
      paramFile = _inputDecorator.decorate(localIOContext, localFileInputStream);
    }
    ...
    throws IOException, JsonParseException
  {
    ...
    if (_inputDecorator != null) {
      localInputStream = _inputDecorator.decorate(localIOContext, paramInputStream);
    }
    ...
    throws IOException, JsonParseException
  {
    ...
    if (_inputDecorator != null) {
      localReader = _inputDecorator.decorate(localIOContext, paramReader);
    }
    ...
    throws IOException, JsonParseException
  {
    ...
    if (_inputDecorator != null) {
      paramString = _inputDecorator.decorate(localIOContext, localStringReader);
    }
    ...
    throws IOException, JsonParseException
  {
    ...
    if (_inputDecorator != null) {
      paramURL = _inputDecorator.decorate(localIOContext, localInputStream);
    }
    ...
    throws IOException, JsonParseException
  {
    ...
    if (_inputDecorator != null)
    {
      InputStream localInputStream = _inputDecorator.decorate(localIOContext, paramArrayOfByte, 0, paramArrayOfByte.length);
    ...
    throws IOException, JsonParseException
  {
    ...
    if (_inputDecorator != null)
    {
      InputStream localInputStream = _inputDecorator.decorate(localIOContext, paramArrayOfByte, paramInt1, paramInt2);
      if (localInputStream != null) {
        return _createJsonParser(localInputStream, localIOContext);
      }
    }
  ...
  {
    _parserFeatures &= (paramFeature.getMask() ^ 0xFFFFFFFF);
    return this;
  }
  ...
  {
    _parserFeatures |= paramFeature.getMask();
    return this;
  }
