  ...
  extends WebChromeClient
{
  ...
  {
    LOG.d(LOG_TAG, "onExceededDatabaseQuota estimatedSize: %d  currentQuota: %d  totalUsedQuota: %d", new Object[] { Long.valueOf(paramLong2), Long.valueOf(paramLong1), Long.valueOf(paramLong3) });
    if (paramLong2 < MAX_QUOTA)
    {
      LOG.d(LOG_TAG, "calling quotaUpdater.updateQuota newQuota: %d", new Object[] { Long.valueOf(paramLong2) });
    ...
    if ((paramString3 != null) && (paramString3.startsWith("gap"))) {
      if (paramString3.startsWith("gap-iab://"))
      {
        ...
        if (paramString1.startsWith("InAppBrowser"))
        {
          ...
          for (;;)
          {
            webView.sendPluginResult(paramWebView, paramString1);
      ...
      {
        LOG.w(LOG_TAG, "InAppBrowser does not support Cordova API calls: " + paramString1 + " " + paramString3);
...
/* Location:
 * Qualified Name:     org.apache.cordova.InAppChromeClient
