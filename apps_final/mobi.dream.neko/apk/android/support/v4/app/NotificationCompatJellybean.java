...
class NotificationCompatJellybean
{
  ...
  {
    paramCharSequence1 = new Notification.BigPictureStyle(b).setBigContentTitle(paramCharSequence1).bigPicture(paramBitmap1);
    if (paramBoolean2) {
  ...
  {
    paramCharSequence1 = new Notification.BigTextStyle(b).setBigContentTitle(paramCharSequence1).bigText(paramCharSequence3);
    if (paramBoolean) {
      paramCharSequence1.setSummaryText(paramCharSequence2);
    }
  }
  ...
  {
    paramCharSequence1 = new Notification.InboxStyle(b).setBigContentTitle(paramCharSequence1);
    if (paramBoolean) {
      paramCharSequence1.setSummaryText(paramCharSequence2);
    }
