...
.method public cO()Ljava/util/ArrayList;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public cR()Lcom/google/android/gms/plus/model/people/Person;
    .locals 6

    new-instance v0, Lcom/google/android/gms/internal/eu;

    invoke-virtual {p0}, Lcom/google/android/gms/internal/fg;->getDisplayName()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p0}, Lcom/google/android/gms/internal/fg;->getId()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {p0}, Lcom/google/android/gms/internal/fg;->getImage()Lcom/google/android/gms/plus/model/people/Person$Image;

    move-result-object v3

    check-cast v3, Lcom/google/android/gms/internal/eu$d;

    invoke-virtual {p0}, Lcom/google/android/gms/internal/fg;->getObjectType()I

    move-result v4

    invoke-virtual {p0}, Lcom/google/android/gms/internal/fg;->getUrl()Ljava/lang/String;

    move-result-object v5

    invoke-direct/range {v0 .. v5}, Lcom/google/android/gms/internal/eu;-><init>(Ljava/lang/String;Ljava/lang/String;Lcom/google/android/gms/internal/eu$d;ILjava/lang/String;)V
...
.method public synthetic freeze()Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/internal/fg;->cR()Lcom/google/android/gms/plus/model/people/Person;
...
.method public getDisplayName()Ljava/lang/String;
    ...
    invoke-virtual {p0, v0}, Lcom/google/android/gms/internal/fg;->getString(Ljava/lang/String;)Ljava/lang/String;
...
.method public synthetic getEmails()Ljava/util/List;
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/internal/fg;->cN()Ljava/util/ArrayList;
...
.method public getImage()Lcom/google/android/gms/plus/model/people/Person$Image;
    ...
    invoke-virtual {p0, v1}, Lcom/google/android/gms/internal/fg;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    invoke-direct {v0, v1}, Lcom/google/android/gms/internal/eu$d;-><init>(Ljava/lang/String;)V
...
.method public getObjectType()I
    ...
    invoke-static {v0}, Lcom/google/android/gms/internal/eu$f;->G(Ljava/lang/String;)I
...
.method public synthetic getOrganizations()Ljava/util/List;
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/internal/fg;->cO()Ljava/util/ArrayList;
...
.method public synthetic getPlacesLived()Ljava/util/List;
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/internal/fg;->cP()Ljava/util/ArrayList;
...
.method public synthetic getUrls()Ljava/util/List;
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/internal/fg;->cQ()Ljava/util/ArrayList;
